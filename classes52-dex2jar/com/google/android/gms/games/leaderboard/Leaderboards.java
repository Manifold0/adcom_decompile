...
public interface Leaderboards
{
    ...
    Intent getLeaderboardIntent(final GoogleApiClient p0, final String p1, final int p2);
    
    Intent getLeaderboardIntent(final GoogleApiClient p0, final String p1, final int p2, final int p3);
