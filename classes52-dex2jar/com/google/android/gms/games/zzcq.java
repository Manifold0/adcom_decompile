...
final class zzcq extends zzah<Intent>
{
    ...
    zzcq(final TurnBasedMultiplayerClient turnBasedMultiplayerClient, final int zzdl, final int zzdm, final boolean zzdn) {
        this.zzdl = zzdl;
        this.zzdm = zzdm;
        this.zzdn = zzdn;
    }
    ...
    protected final void zza(final zze zze, final TaskCompletionSource<Intent> taskCompletionSource) throws RemoteException {
        taskCompletionSource.setResult((Object)zze.zza(this.zzdl, this.zzdm, this.zzdn));
    }
}
