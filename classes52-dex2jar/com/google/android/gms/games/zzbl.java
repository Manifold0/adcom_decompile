...
final class zzbl extends zzs<zzh>
{
    ...
    zzbl(final RealTimeMultiplayerClient realTimeMultiplayerClient, final ListenerHolder listenerHolder, final ListenerHolder zzbi, final RoomConfig zzdo) {
        this.zzbi = zzbi;
        this.zzdo = zzdo;
    ...
    protected final void zzb(final zze zze, final TaskCompletionSource<Void> taskCompletionSource) throws RemoteException, SecurityException {
        zze.zzc((ListenerHolder<? extends RoomUpdateListener>)this.zzbi, (ListenerHolder<? extends RoomStatusUpdateListener>)this.zzbi, (ListenerHolder<? extends RealTimeMessageReceivedListener>)this.zzbi, this.zzdo);
