...
public final class MediaBrowserCompat
{
    ...
    private static class CallbackHandler extends Handler
    {
        ...
        public void handleMessage(final Message message) {
            if (this.mCallbacksMessengerRef != null && this.mCallbacksMessengerRef.get() != null && this.mCallbackImplRef.get() != null) {
                Bundle data = null;
                MediaBrowserServiceCallbackImpl mediaBrowserServiceCallbackImpl = null;
                ...
                Label_0209: {
                    ...
                    Label_0169:
                        while (true) {
                            ...
                            mediaBrowserServiceCallbackImpl = this.mCallbackImplRef.get();
                            messenger = this.mCallbacksMessengerRef.get();
                            while (true) {
                                Label_0238: {
                                    try {
                                        switch (message.what) {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal
    {
        ...
        public MediaBrowserImplApi21(final Context mContext, final ComponentName componentName, final ConnectionCallback connectionCallback, final Bundle bundle) {
            ...
            this.mSubscriptions = (ArrayMap<String, Subscription>)new ArrayMap();
        ...
        public void onLoadChildren(final Messenger messenger, final String s, final List list, final Bundle bundle) {
            if (this.mCallbacksMessenger == messenger) {
                final Subscription subscription = (Subscription)this.mSubscriptions.get((Object)s);
        ...
        public void subscribe(@NonNull final String s, final Bundle bundle, @NonNull final SubscriptionCallback subscriptionCallback) {
            ...
            if ((subscription = (Subscription)this.mSubscriptions.get((Object)s)) == null) {
                subscription = new Subscription();
                this.mSubscriptions.put((Object)s, (Object)subscription);
            }
        ...
        public void unsubscribe(@NonNull final String s, final SubscriptionCallback subscriptionCallback) {
            ...
            if (subscription != null) {
                ...
                if (subscription.isEmpty() || subscriptionCallback == null) {
                    this.mSubscriptions.remove((Object)s);
                }
            }
        }
    }
