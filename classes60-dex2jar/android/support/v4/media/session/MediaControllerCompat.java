...
public final class MediaControllerCompat
{
    ...
    public static MediaControllerCompat getMediaController(@NonNull final Activity activity) {
        ...
        if (activity instanceof SupportActivity) {
            final MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData)((SupportActivity)activity).getExtraData((Class)MediaControllerExtraData.class);
    ...
    private static void validateCustomAction(final String s, final Bundle bundle) {
        if (s != null) {
            switch (s) {
                default: {}
