...
public abstract class MediaBrowserServiceCompat extends Service
{
    ...
    public MediaBrowserServiceCompat() {
        this.mConnections = (ArrayMap<IBinder, ConnectionRecord>)new ArrayMap();
    ...
    void addSubscription(final String s, final ConnectionRecord connectionRecord, final IBinder binder, final Bundle bundle) {
        ...
        list.add((Pair<IBinder, Bundle>)new Pair((Object)binder, (Object)bundle));
    ...
    void performLoadChildren(final String s, final ConnectionRecord mCurConnection, final Bundle bundle) {
        final Result<List<MediaBrowserCompat.MediaItem>> result = new Result<List<MediaBrowserCompat.MediaItem>>(s) {
            void onResultSent(List<MediaBrowserCompat.MediaItem> applyOptions) {
                if (MediaBrowserServiceCompat.this.mConnections.get((Object)mCurConnection.callbacks.asBinder()) != mCurConnection) {
        ...
        public void notifyChildrenChanged(final String s, final Bundle bundle) {
            ...
            MediaBrowserServiceCompat.this.mHandler.post((Runnable)new Runnable() {
                ...
                public void run() {
                    ...
                    while (iterator.hasNext()) {
                        final ConnectionRecord connectionRecord = (ConnectionRecord)MediaBrowserServiceCompat.this.mConnections.get((Object)iterator.next());
                        final List<Pair<IBinder, Bundle>> list = connectionRecord.subscriptions.get(s);
                        if (list != null) {
                            for (final Pair<IBinder, Bundle> pair : list) {
                ...
                public void run() {
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (extraBinder != null) {
                            ...
                            while (iterator.hasNext()) {
                                BundleCompat.putBinder((Bundle)iterator.next(), "extra_session_binder", extraBinder.asBinder());
                            }
                        }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl
    {
        ...
        public void setSessionToken(final MediaSessionCompat.Token token) {
            MediaBrowserServiceCompat.this.mHandler.post((Runnable)new Runnable() {
                @Override
                public void run() {
                    final Iterator<ConnectionRecord> iterator = (Iterator<ConnectionRecord>)MediaBrowserServiceCompat.this.mConnections.values().iterator();
                    while (iterator.hasNext()) {
    ...
    private class ServiceBinderImpl
    {
        ...
        public void addSubscription(final String s, final IBinder binder, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                @Override
                public void run() {
                    final ConnectionRecord connectionRecord = (ConnectionRecord)MediaBrowserServiceCompat.this.mConnections.get((Object)serviceCallbacks.asBinder());
        ...
        public void connect(final String s, final int n, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                ...
                public void run() {
                    ...
                    MediaBrowserServiceCompat.this.mConnections.remove((Object)binder);
                    ...
                    Label_0173: {
                        ...
                        try {
                            MediaBrowserServiceCompat.this.mConnections.put((Object)binder, (Object)connectionRecord);
                            if (MediaBrowserServiceCompat.this.mSession != null) {
        ...
        public void disconnect(final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                @Override
                public void run() {
                    if (MediaBrowserServiceCompat.this.mConnections.remove((Object)serviceCallbacks.asBinder()) != null) {}
                }
            });
        }
        ...
        public void unregisterCallbacks(final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                @Override
                public void run() {
                    MediaBrowserServiceCompat.this.mConnections.remove((Object)serviceCallbacks.asBinder());
                }
            });
        }
    }
