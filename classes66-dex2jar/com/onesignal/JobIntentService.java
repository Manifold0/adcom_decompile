...
abstract class JobIntentService extends Service
{
    ...
    static {
        sLock = new Object();
        sClassWorkEnqueuer = new HashMap<ComponentNameWithWakeful, WorkEnqueuer>();
    }
    ...
    public static void enqueueWork(@NonNull final Context context, @NonNull final ComponentName componentName, final int n, @NonNull final Intent intent, final boolean b) {
        if (intent == null) {
            throw new IllegalArgumentException("work must not be null");
        }
        final WorkEnqueuer workEnqueuer;
        synchronized (JobIntentService.sLock) {
            workEnqueuer = getWorkEnqueuer(context, componentName, true, n, b);
            workEnqueuer.ensureJobId(n);
            try {
                workEnqueuer.enqueueWork(intent);
                return;
            }
            catch (IllegalStateException workEnqueuer) {
                if (b) {
    ...
    public static void enqueueWork(@NonNull final Context context, @NonNull final Class clazz, final int n, @NonNull final Intent intent, final boolean b) {
    ...
    static WorkEnqueuer getWorkEnqueuer(final Context context, final ComponentName componentName, final boolean b, final int n, final boolean b2) {
        ...
        if ((workEnqueuer = JobIntentService.sClassWorkEnqueuer.get(componentNameWithWakeful)) == null) {
            ...
            JobIntentService.sClassWorkEnqueuer.put(componentNameWithWakeful, workEnqueuer2);
            workEnqueuer = workEnqueuer2;
        }
        return workEnqueuer;
    }
    ...
    GenericWorkItem dequeueWork() {
        if (this.mJobImpl != null) {
            final GenericWorkItem dequeueWork = this.mJobImpl.dequeueWork();
            if (dequeueWork != null) {
                return dequeueWork;
            }
        }
    ...
    abstract static class WorkEnqueuer
    {
        ...
        void ensureJobId(final int mJobId) {
            if (!this.mHasJobId) {
                ...
                throw new IllegalArgumentException("Given job ID " + mJobId + " is different than previous " + this.mJobId);
            }
        }
