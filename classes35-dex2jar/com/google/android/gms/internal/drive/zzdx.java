...
final class zzdx extends zzl
{
    ...
    public zzdx(final BaseImplementation$ResultHolder<DriveApi.MetadataBufferResult> zzdv) {
        this.zzdv = zzdv;
    }
    ...
    public final void zza(final zzfp zzfp) throws RemoteException {
        this.zzdv.setResult((Object)new zzaq(Status.RESULT_SUCCESS, new MetadataBuffer(zzfp.zzht), false));
    }
}
