...
public class VectorDrawableCompat extends VectorDrawableCommon
{
            ...
            if (n2 == 2) {
                ...
                if ("path".equals(name)) {
                    ...
                    if (((VPath)vFullPath).getPathName() != null) {
                        mvPathRenderer.mVGTargetsMap.put((Object)((VPath)vFullPath).getPathName(), (Object)vFullPath);
                    }
                    n3 = 0;
                    ...
                    if (((VPath)vClipPath).getPathName() != null) {
                        mvPathRenderer.mVGTargetsMap.put((Object)((VPath)vClipPath).getPathName(), (Object)vClipPath);
                    }
                    ...
                    if ("group".equals(name)) {
                        ...
                        if (vGroup2.getGroupName() != null) {
                            mvPathRenderer.mVGTargetsMap.put((Object)vGroup2.getGroupName(), (Object)vGroup2);
                        }
    ...
    private boolean needMirroring() {
        return Build$VERSION.SDK_INT >= 17 && (this.isAutoMirrored() && DrawableCompat.getLayoutDirection((Drawable)this) == 1);
    }
    ...
    private void updateStateFromTypedArray(final TypedArray typedArray, final XmlPullParser xmlPullParser) throws XmlPullParserException {
        ...
        if (string != null) {
            ...
            mvPathRenderer.mVGTargetsMap.put((Object)string, (Object)mvPathRenderer);
        }
    }
    ...
    Object getTargetByName(final String s) {
        return this.mVectorState.mVPathRenderer.mVGTargetsMap.get((Object)s);
    }
            ...
            for (int i = 0; i < mChildren.size(); ++i) {
                ...
                if (value instanceof VGroup) {
                    ...
                    if (vPath.mPathName != null) {
                        arrayMap.put((Object)vPath.mPathName, (Object)vPath);
                    }
                }
            }
        }
    ...
    private static class VPathRenderer
    {
        ...
        public VPathRenderer() {
            ...
            this.mRootAlpha = 255;
            this.mRootName = null;
            this.mVGTargetsMap = (ArrayMap<String, Object>)new ArrayMap();
        ...
        public VPathRenderer(final VPathRenderer vPathRenderer) {
            ...
            if (vPathRenderer.mRootName != null) {
                this.mVGTargetsMap.put((Object)vPathRenderer.mRootName, (Object)this);
            }
        }
