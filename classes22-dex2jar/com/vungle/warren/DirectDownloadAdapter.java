...
public class DirectDownloadAdapter
{
    ...
    public DirectDownloadAdapter(final PublisherDirectDownload pubsDownloadClient, final String s) {
        this.sdkDownloadClient = new SDKDownloadClient(s);
        (this.pubsDownloadClient = pubsDownloadClient).setSDKCallbackReceiver(this.getSdkDownloadClient().getCallBackReceiver());
        this.sdkDownloadClient.setSendingReceiver(this.getPubsDownloadClient().getPublisherReceiver());
    }
