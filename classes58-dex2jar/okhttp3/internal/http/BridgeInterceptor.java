...
public final class BridgeInterceptor implements Interceptor
{
    ...
    public Response intercept(final Chain chain) throws IOException {
        ...
        if (n != 0 && "gzip".equalsIgnoreCase(proceed.header("Content-Encoding")) && HttpHeaders.hasBody(proceed)) {
            final GzipSource gzipSource = new GzipSource((Source)proceed.body().source());
