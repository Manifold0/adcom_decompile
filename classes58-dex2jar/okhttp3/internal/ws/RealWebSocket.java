        ...
        (this.call = Internal.instance.newWebSocketCall(build, build2)).enqueue(new Callback() {
            ...
            public void onResponse(final Call call, final Response response) {
                ...
                try {
                    ...
                    final int n = pingIntervalMillis;
                    final long n2 = n;
                    final Streams streams = webSocketStreams;
                    realWebSocket3.initReaderAndWriter(s4, n2, streams);
                    ...
                    final Callback callback6 = this;
                    final RealWebSocket realWebSocket4 = callback6.this$0;
