...
final class Hpack
{
    ...
    static final class Reader
    {
        ...
        ByteString readByteString() throws IOException {
            ...
            if (n != 0) {
                return ByteString.of(Huffman.get().decode(this.source.readByteArray((long)int1)));
            }
            return this.source.readByteString((long)int1);
        }
    ...
    static final class Writer
    {
        ...
        void writeHeaders(final List<Header> list) throws IOException {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                else if (asciiLowercase.startsWith(Header.PSEUDO_PREFIX) && !Header.TARGET_AUTHORITY.equals((Object)asciiLowercase)) {
