...
public abstract class ResponseBody implements Closeable
{
    ...
    public static ResponseBody create(final MediaType mediaType, final String s) {
        ...
        return create(parse, writeString.size(), (BufferedSource)writeString);
    }
    
    public static ResponseBody create(final MediaType mediaType, final byte[] array) {
        return create(mediaType, array.length, (BufferedSource)new Buffer().write(array));
    }
