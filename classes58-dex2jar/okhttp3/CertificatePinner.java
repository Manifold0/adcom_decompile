...
public final class CertificatePinner
{
            ...
            for (int i = 0; i < ((List)clean).size(); ++i) {
                ...
                for (int j = 0; j < matchingPins.size(); ++j) {
                    ...
                    if (pin.hashAlgorithm.equals("sha256/")) {
                        ...
                        if (pin.hash.equals((Object)sha256)) {
                            return;
                        }
                        byteString2 = sha256;
                    }
                        ...
                        byteString = sha257;
                        if (pin.hash.equals((Object)sha257)) {
                            return;
                        }
                    }
                }
    ...
    static final class Pin
    {
        ...
        @Override
        public boolean equals(final Object o) {
            return o instanceof Pin && this.pattern.equals(((Pin)o).pattern) && this.hashAlgorithm.equals(((Pin)o).hashAlgorithm) && this.hash.equals((Object)((Pin)o).hash);
        }
