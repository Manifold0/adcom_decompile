...
public class NotificationCompat
{
    ...
    public static class DecoratedCustomViewStyle extends Style
    {
        ...
        private RemoteViews createRemoteViews(final RemoteViews remoteViews, final boolean b) {
                ...
                if (this.mBuilder.mActions != null) {
                    ...
                    if (min > 0) {
                        ...
                        while (true) {
                            ...
                            applyStandardTemplate.addView(R$id.actions, this.generateActionButton(this.mBuilder.mActions.get(n5)));
                            ++n5;
                        }
                    }
                }
            ...
            applyStandardTemplate.setViewVisibility(R$id.actions, n6);
            applyStandardTemplate.setViewVisibility(R$id.action_divider, n6);
    ...
    public abstract static class Style
    {
        ...
        private Bitmap createIconWithBackground(int n, final int n2, final int n3, final int n4) {
