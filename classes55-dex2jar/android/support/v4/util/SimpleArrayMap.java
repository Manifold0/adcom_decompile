...
public class SimpleArrayMap<K, V>
{
    ...
    int indexOf(final Object o, final int n) {
        ...
        if (mSize == 0) {
            ...
            if ((n2 = binarySearchHashes) >= 0) {
                n2 = binarySearchHashes;
                if (!o.equals(this.mArray[binarySearchHashes << 1])) {
                    int n3;
                    for (n3 = binarySearchHashes + 1; n3 < mSize && this.mHashes[n3] == n; ++n3) {
                        if (o.equals(this.mArray[n3 << 1])) {
                            return n3;
                        }
                    }
                    for (int n4 = binarySearchHashes - 1; n4 >= 0 && this.mHashes[n4] == n; --n4) {
    ...
    int indexOfNull() {
        ...
        if (mSize == 0) {
            ...
            if ((n = binarySearchHashes) >= 0) {
                n = binarySearchHashes;
                if (this.mArray[binarySearchHashes << 1] != null) {
                    int n2;
                    for (n2 = binarySearchHashes + 1; n2 < mSize && this.mHashes[n2] == 0; ++n2) {
                        if (this.mArray[n2 << 1] == null) {
                            return n2;
                        }
                    }
                    for (int n3 = binarySearchHashes - 1; n3 >= 0 && this.mHashes[n3] == 0; --n3) {
    ...
    public V removeAt(final int n) {
        ...
        if (mSize <= 1) {
            ...
            if (this.mHashes.length > 8 && this.mSize < this.mHashes.length / 3) {
                ...
                if (n < (mSize2 = n3)) {
                    System.arraycopy(mHashes, n + 1, this.mHashes, n, n3 - n);
                    System.arraycopy(mArray, n + 1 << 1, this.mArray, n << 1, n3 - n << 1);
                    mSize2 = n3;
                }
            }
            else {
