...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat
{
    ...
    private SparseArrayCompat<AccessibilityNodeInfoCompat> getAllNodes() {
        ...
        for (int i = 0; i < list.size(); ++i) {
            sparseArrayCompat.put(i, (Object)this.createNodeForChild(i));
        }
        return (SparseArrayCompat<AccessibilityNodeInfoCompat>)sparseArrayCompat;
    }
    ...
    private boolean moveFocus(int key, @Nullable final Rect rect) {
        ...
        if (accessibilityNodeInfoCompat2 == null) {
            ...
            key = allNodes.keyAt(allNodes.indexOfValue((Object)accessibilityNodeInfoCompat2));
        }
    ...
    private boolean requestAccessibilityFocus(final int mAccessibilityFocusedVirtualViewId) {
        if (this.mManager.isEnabled() && this.mManager.isTouchExplorationEnabled() && this.mAccessibilityFocusedVirtualViewId != mAccessibilityFocusedVirtualViewId) {
