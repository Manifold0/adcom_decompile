...
public class NestedScrollingChildHelper
{
    ...
    public boolean dispatchNestedFling(final float n, final float n2, final boolean b) {
        ...
        if (this.isNestedScrollingEnabled()) {
            ...
            if (nestedScrollingParentForType != null) {
                onNestedFling = ViewParentCompat.onNestedFling(nestedScrollingParentForType, this.mView, n, n2, b);
            }
        }
    ...
    public boolean dispatchNestedPreFling(final float n, final float n2) {
        boolean onNestedPreFling = false;
        if (this.isNestedScrollingEnabled()) {
            final ViewParent nestedScrollingParentForType = this.getNestedScrollingParentForType(0);
            onNestedPreFling = onNestedPreFling;
            if (nestedScrollingParentForType != null) {
                onNestedPreFling = ViewParentCompat.onNestedPreFling(nestedScrollingParentForType, this.mView, n, n2);
            }
        }
