...
public class FragmentActivity extends BaseFragmentActivityApi16 implements ActivityCompat$OnRequestPermissionsResultCallback, ActivityCompat$RequestPermissionsRequestCodeValidator
{
    ...
    private int allocateRequestIndex(final Fragment fragment) {
        ...
        this.mPendingFragmentActivityResults.put(mNextCandidateRequestIndex, (Object)fragment.mWho);
        this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % 65534;
        return mNextCandidateRequestIndex;
    }
    
    private static void markState(final FragmentManager fragmentManager, final Lifecycle$State lifecycle$State) {
        for (final Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                fragment.mLifecycleRegistry.markState(lifecycle$State);
                markState(fragment.getChildFragmentManager(), lifecycle$State);
            }
        }
    }
        ...
        if (bundle != null) {
            ...
            if (bundle.containsKey("android:support:next_request_index")) {
                ...
                if (intArray == null || stringArray == null || intArray.length != stringArray.length) {
                    ...
                    this.mPendingFragmentActivityResults = (SparseArrayCompat<String>)new SparseArrayCompat(intArray.length);
                    for (int i = 0; i < intArray.length; ++i) {
                        this.mPendingFragmentActivityResults.put(intArray[i], (Object)stringArray[i]);
                    }
                }
            }
        }
        if (this.mPendingFragmentActivityResults == null) {
            this.mPendingFragmentActivityResults = (SparseArrayCompat<String>)new SparseArrayCompat();
    ...
    void requestPermissionsFromFragment(final Fragment fragment, final String[] array, final int n) {
        if (n == -1) {
            ActivityCompat.requestPermissions((Activity)this, array, n);
            return;
        }
        BaseFragmentActivityApi14.checkForValidRequestCode(n);
        try {
            this.mRequestedPermissionsFromFragment = true;
            ActivityCompat.requestPermissions((Activity)this, array, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n));
        }
        finally {
    ...
    public void startActivityFromFragment(final Fragment fragment, final Intent intent, final int n, @Nullable final Bundle bundle) {
        ...
        Label_0024: {
            ...
            try {
                ...
                return;
                BaseFragmentActivityApi14.checkForValidRequestCode(n);
                ActivityCompat.startActivityForResult((Activity)this, intent, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n), bundle);
            }
            finally {
    ...
    public void startIntentSenderFromFragment(final Fragment fragment, final IntentSender intentSender, final int n, @Nullable final Intent intent, final int n2, final int n3, final int n4, final Bundle bundle) throws IntentSender$SendIntentException {
        ...
        Label_0032: {
            ...
            try {
                ...
                return;
                BaseFragmentActivityApi14.checkForValidRequestCode(n);
                ActivityCompat.startIntentSenderForResult((Activity)this, intentSender, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n), intent, n2, n3, n4, bundle);
            }
            finally {
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity>
    {
        ...
        public boolean onShouldShowRequestPermissionRationale(@NonNull final String s) {
            return ActivityCompat.shouldShowRequestPermissionRationale((Activity)FragmentActivity.this, s);
        }
