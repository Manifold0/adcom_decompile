...
public abstract class FragmentHostCallback<E> extends FragmentContainer
{
    ...
    LoaderManagerImpl getLoaderManager(final String s, final boolean b, final boolean b2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = (SimpleArrayMap<String, LoaderManager>)new SimpleArrayMap();
        }
        final LoaderManagerImpl loaderManagerImpl = (LoaderManagerImpl)this.mAllLoaderManagers.get((Object)s);
        ...
        if (loaderManagerImpl == null && b2) {
            ...
            this.mAllLoaderManagers.put((Object)s, (Object)loaderManagerImpl2);
    ...
    void inactivateFragment(final String s) {
        if (this.mAllLoaderManagers != null) {
            ...
            if (loaderManagerImpl != null && !loaderManagerImpl.mRetaining) {
                ...
                this.mAllLoaderManagers.remove((Object)s);
            }
        }
    }
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            while (true) {
                ...
                if (loaderManagerImpl.mRetaining) {
                    ...
                    loaderManagerImpl.doDestroy();
                    this.mAllLoaderManagers.remove((Object)loaderManagerImpl.mWho);
                }
                ++n5;
            }
        }
