...
public class FacebookWebFallbackDialog extends WebDialog
{
    ...
    public static FacebookWebFallbackDialog newInstance(final Context context, final String s, final String s2) {
        WebDialog.initDefaultTheme(context);
        return new FacebookWebFallbackDialog(context, s, s2);
    }
