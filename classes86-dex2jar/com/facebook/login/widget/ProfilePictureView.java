...
public class ProfilePictureView extends FrameLayout
{
    ...
    private void processResponse(final ImageResponse imageResponse) {
        if (imageResponse.getRequest() == this.lastRequest) {
            ...
            if (error != null) {
                ...
                onErrorListener.onError(new FacebookException("Error in downloading profile picture for profileId: " + this.getProfileId(), (Throwable)error));
            }
            else if (bitmap != null) {
    ...
    private void sendImageRequest(final boolean allowCachedRedirects) {
        final ImageRequest build = new ImageRequest$Builder(this.getContext(), ImageRequest.getProfilePictureUri(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedRedirects).setCallerTag((Object)this).setCallback((ImageRequest$Callback)new ImageRequest$Callback() {
    ...
    public final void setProfileId(@Nullable final String profileId) {
        boolean b = false;
