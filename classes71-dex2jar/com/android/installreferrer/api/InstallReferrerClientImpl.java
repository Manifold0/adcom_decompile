...
class InstallReferrerClientImpl extends InstallReferrerClient
{
    ...
    public InstallReferrerClientImpl(@NonNull final Context context) {
        this.mClientState = 0;
    ...
    @Override
    public void startConnection(@NonNull final InstallReferrerStateListener installReferrerStateListener) {
        if (this.isReady()) {
