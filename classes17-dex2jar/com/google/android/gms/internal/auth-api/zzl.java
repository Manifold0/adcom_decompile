...
final class zzl extends zzp<Status>
{
    ...
    zzl(final zzi zzi, final GoogleApiClient googleApiClient, final Credential zzao) {
        this.zzao = zzao;
    ...
    protected final void zzc(final Context context, final zzw zzw) throws RemoteException {
        zzw.zzc(new zzo((BaseImplementation$ResultHolder<Status>)this), new zzy(this.zzao));
    }
}
