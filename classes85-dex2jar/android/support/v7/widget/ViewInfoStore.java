...
class ViewInfoStore
{
    ...
    ViewInfoStore() {
        this.mLayoutHolderMap = (ArrayMap<RecyclerView.ViewHolder, InfoRecord>)new ArrayMap();
    ...
    static class InfoRecord
    {
        ...
        static {
            InfoRecord.sPool = (Pools$Pool<InfoRecord>)new Pools$SimplePool(20);
        }
        ...
        static InfoRecord obtain() {
            ...
            if ((infoRecord = (InfoRecord)InfoRecord.sPool.acquire()) == null) {
        ...
        static void recycle(final InfoRecord infoRecord) {
            ...
            InfoRecord.sPool.release((Object)infoRecord);
        }
    }
