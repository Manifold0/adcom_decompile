...
public class DefaultItemAnimator extends SimpleItemAnimator
{
    ...
    private void animateRemoveImpl(final ViewHolder viewHolder) {
        ...
        animate.setDuration(((RecyclerView.ItemAnimator)this).getRemoveDuration()).alpha(0.0f).setListener((ViewPropertyAnimatorListener)new VpaListenerAdapter() {
            @Override
    ...
    void animateAddImpl(final ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(((RecyclerView.ItemAnimator)this).getAddDuration()).setListener((ViewPropertyAnimatorListener)new VpaListenerAdapter() {
            @Override
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (itemView != null) {
            ...
            setDuration.alpha(0.0f).setListener((ViewPropertyAnimatorListener)new VpaListenerAdapter() {
                @Override
                public void onAnimationEnd(final View view) {
                    setDuration.setListener((ViewPropertyAnimatorListener)null);
                    ViewCompat.setAlpha(view, 1.0f);
        ...
        if (itemView2 != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(((RecyclerView.ItemAnimator)this).getChangeDuration()).alpha(1.0f).setListener((ViewPropertyAnimatorListener)new VpaListenerAdapter() {
                @Override
                public void onAnimationEnd(final View view) {
                    animate.setListener((ViewPropertyAnimatorListener)null);
    ...
    void animateMoveImpl(final ViewHolder viewHolder, int n, int n2, final int n3, final int n4) {
        ...
        animate.setDuration(((RecyclerView.ItemAnimator)this).getMoveDuration()).setListener((ViewPropertyAnimatorListener)new VpaListenerAdapter() {
            @Override
            public void onAnimationCancel(final View view) {
                if (n != 0) {
                    ViewCompat.setTranslationX(view, 0.0f);
    ...
    public void runPendingAnimations() {
        ...
        if (b || b2 || b4 || b3) {
            ...
            if (b2) {
                ...
                if (b) {
                    ViewCompat.postOnAnimationDelayed(list.get(0).holder.itemView, (Runnable)runnable, ((RecyclerView.ItemAnimator)this).getRemoveDuration());
                }
                else {
                    runnable.run();
                }
            ...
            if (b3) {
                ...
                if (b) {
                    ViewCompat.postOnAnimationDelayed(list2.get(0).oldHolder.itemView, (Runnable)runnable2, ((RecyclerView.ItemAnimator)this).getRemoveDuration());
                }
                else {
                    runnable2.run();
                }
            ...
            if (b4) {
                ...
                if (b || b2 || b3) {
                    ...
                    ViewCompat.postOnAnimationDelayed(list3.get(0).itemView, (Runnable)runnable3, removeDuration + Math.max(moveDuration, changeDuration));
                    return;
                }
                runnable3.run();
            }
