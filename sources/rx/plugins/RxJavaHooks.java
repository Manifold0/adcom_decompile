...
public final class RxJavaHooks {
    ...
    static class C33371 implements Action1<Throwable> {
        C33371() {
        }
    ...
    static class C33382 implements Func2<Observable, Observable.OnSubscribe, Observable.OnSubscribe> {
        C33382() {
        }
    ...
    static class C33393 implements Func1<Subscription, Subscription> {
        C33393() {
        }
    ...
    static class C33404 implements Func2<Single, Observable.OnSubscribe, Observable.OnSubscribe> {
        C33404() {
        }
    ...
    static class C33415 implements Func1<Subscription, Subscription> {
        C33415() {
        }
    ...
    static class C33426 implements Func2<Completable, OnSubscribe, OnSubscribe> {
        C33426() {
        }
    ...
    static class C33437 implements Func1<Action0, Action0> {
        C33437() {
        }
    ...
    static class C33448 implements Func1<Throwable, Throwable> {
        C33448() {
        }
    ...
    static class C33459 implements Func1<Observable.Operator, Observable.Operator> {
        C33459() {
        }
    ...
    static void init() {
        onError = new C33371();
        onObservableStart = new C33382();
        onObservableReturn = new C33393();
        onSingleStart = new C33404();
        onSingleReturn = new C33415();
        onCompletableStart = new C33426();
        onScheduleAction = new C33437();
        onObservableSubscribeError = new C33448();
        onObservableLift = new C33459();
