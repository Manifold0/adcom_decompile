...
public class RxJavaPlugins {
    static final RxJavaErrorHandler DEFAULT_ERROR_HANDLER = new C33461();
    ...
    static class C33461 extends RxJavaErrorHandler {
        C33461() {
        }
    }

    /* renamed from: rx.plugins.RxJavaPlugins$2 */
    class C33472 extends RxJavaCompletableExecutionHook {
        C33472() {
        }
    }
    ...
    public RxJavaCompletableExecutionHook getCompletableExecutionHook() {
        if (this.completableExecutionHook.get() == null) {
            ...
            if (impl == null) {
                this.completableExecutionHook.compareAndSet(null, new C33472());
            } else {
