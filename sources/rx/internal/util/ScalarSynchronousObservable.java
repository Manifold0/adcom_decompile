...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    static final class ScalarAsyncProducer<T> extends AtomicBoolean implements Producer, Action0 {
        ...
        public String toString() {
            return "ScalarAsyncProducer[" + this.value + ", " + get() + RequestParameters.RIGHT_BRACKETS;
        }
    }
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        return Observable.create(new ScalarAsyncOnSubscribe(this.f8388t, onSchedule));
    }

    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func) {
        return Observable.create(new OnSubscribe<R>() {
            public void call(Subscriber<? super R> child) {
                Observable<? extends R> o = (Observable) func.call(ScalarSynchronousObservable.this.f8388t);
                if (o instanceof ScalarSynchronousObservable) {
                    child.setProducer(ScalarSynchronousObservable.createProducer(child, ((ScalarSynchronousObservable) o).f8388t));
                } else {
