...
public class RxRingBuffer implements Subscription {
    ...
    public static final ObjectPool<Queue<Object>> SPMC_POOL = new C32912();
    public static final ObjectPool<Queue<Object>> SPSC_POOL = new C32901();
    ...
    static class C32901 extends ObjectPool<Queue<Object>> {
        C32901() {
        }
    ...
    static class C32912 extends ObjectPool<Queue<Object>> {
        C32912() {
        }
