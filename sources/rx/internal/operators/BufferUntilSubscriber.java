...
public final class BufferUntilSubscriber<T> extends Subject<T, T> {
    static final Observer EMPTY_OBSERVER = new C31071();
    private boolean forward;
    final State<T> state;

    /* renamed from: rx.internal.operators.BufferUntilSubscriber$1 */
    static class C31071 implements Observer {
        C31071() {
        }
    ...
    static final class OnSubscribeAction<T> implements OnSubscribe<T> {
        ...
        class C31081 implements Action0 {
            C31081() {
            }
        ...
        public void call(Subscriber<? super T> s) {
            if (this.state.casObserverRef(null, s)) {
                s.add(Subscriptions.create(new C31081()));
                boolean win = false;
