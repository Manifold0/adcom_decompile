...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C32592 implements Action0 {
            C32592() {
            }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C32592(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C32601 implements Action0 {
            C32601() {
            }
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C32601(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
