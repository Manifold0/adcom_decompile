...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C31541 implements Action0 {
            C31541() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C31541(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C31551 implements Action0 {
            C31551() {
            }
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C31551(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
