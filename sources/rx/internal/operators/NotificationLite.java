...
public final class NotificationLite<T> {
    ...
    private static final Object ON_COMPLETED_SENTINEL = new C31181();
    private static final Object ON_NEXT_NULL_SENTINEL = new C31192();

    /* renamed from: rx.internal.operators.NotificationLite$1 */
    static class C31181 implements Serializable {
    ...
    static class C31192 implements Serializable {
    ...
    static final class OnErrorSentinel implements Serializable {
        ...
        public String toString() {
            return "Notification=>Error:" + this.f8381e;
        }
    }
    ...
    public boolean accept(Observer<? super T> o, Object n) {
        if (n == ON_COMPLETED_SENTINEL) {
            ...
            o.onError(((OnErrorSentinel) n).f8381e);
            return true;
        } else {
            o.onNext(n);
            return false;
    ...
    public Throwable getError(Object n) {
        return ((OnErrorSentinel) n).f8381e;
    }
}
