...
public final class OnSubscribeRedo<T> implements OnSubscribe<T> {
    static final Func1<Observable<? extends Notification<?>>, Observable<?>> REDO_INFINITE = new C31291();
    ...
    static class C31291 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        /* renamed from: rx.internal.operators.OnSubscribeRedo$1$1 */
        class C31281 implements Func1<Notification<?>, Notification<?>> {
            C31281() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C31281());
        }
    }

    /* renamed from: rx.internal.operators.OnSubscribeRedo$3 */
    class C31333 implements Operator<Notification<?>, Notification<?>> {
        C31333() {
        }
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C31371 implements Func1<Notification<?>, Notification<?>> {
            int num;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C31371()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C31381 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C31381() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C31381());
        }
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new Action0() {
            ...
            class C31301 extends Subscriber<T> {
                boolean done;
            ...
            public void call() {
                if (!subscriber.isUnsubscribed()) {
                    Subscriber<T> terminalDelegatingSubscriber = new C31301();
        ...
        final Observable<?> restarts = (Observable) this.controlHandlerFunction.call(terminals.lift(new C31333()));
