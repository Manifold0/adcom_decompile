...
public abstract class EventReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        if (intent != null && intent.getAction() != null) {
            NotificationInfo info = (NotificationInfo) (intent.hasExtra("notification_info") ? intent.getSerializableExtra("notification_info") : null);
            ...
            switch (obj) {
                ...
                case 1:
                    Throwable reason = (Throwable) intent.getSerializableExtra("registration_failure_reason");
                    if (reason == null) {
