...
public class PushMessage implements Serializable {
    ...
    protected int getIcon(Context context) {
        ...
        if (metaData.containsKey("ddna_notification_icon")) {
            try {
                int identifier;
                Object icon = metaData.get("ddna_notification_icon");
                if (icon instanceof String) {
                    identifier = context.getResources().getIdentifier(metaData.getString("ddna_notification_icon"), "drawable", context.getPackageName());
                } else if (icon instanceof Integer) {
                    identifier = ((Integer) icon).intValue();
                } else {
                    String str;
                    String str2 = BuildConfig.LOG_TAG;
                    String str3 = "Unexpected type %s for ddna_notification_icon";
        ...
        try {
            ...
            return C0936R.drawable.ddna_ic_stat_logo;
