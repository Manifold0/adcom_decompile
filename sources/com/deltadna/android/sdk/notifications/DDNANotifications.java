...
public final class DDNANotifications {
    ...
    public static void register(final Context context, boolean secondary) {
        ...
        try {
            ...
            synchronized (DDNANotifications.class) {
                String name = secondary ? NAME : "[DEFAULT]";
                boolean found = false;
    ...
    public static void setReceiver(@Nullable Class<? extends EventReceiver> receiver) {
        synchronized (DDNANotifications.class) {
            receiver = receiver;
        }
    }
    ...
    public static void recordNotificationOpened(Bundle payload, boolean launch) {
        if (UnityForwarder.isPresent()) {
            ...
            UnityForwarder.getInstance().forward("DeltaDNA.AndroidNotifications", "DidReceivePushNotification", Utils.convert(copy));
            return;
        }
