...
class TrackAmazonPurchase {
    ...
    static /* synthetic */ class C13531 {
        ...
        static final /* synthetic */ int[] f2654x4eb80c9f = new int[RequestStatus.values().length];

        static {
            try {
                f2654x4eb80c9f[RequestStatus.SUCCESSFUL.ordinal()] = 1;
    ...
    private class OSPurchasingListener implements PurchasingListener {
        ...
        public void onProductDataResponse(ProductDataResponse response) {
            if (this.lastRequestId != null && this.lastRequestId.toString().equals(response.getRequestId().toString())) {
                try {
                    switch (C13531.f2654x4eb80c9f[response.getRequestStatus().ordinal()]) {
                        case 1:
                            ...
                            for (String key : products.keySet()) {
                                ...
                                jsonItem.put(AppLovinEventParameters.PRODUCT_IDENTIFIER, product.getSku());
