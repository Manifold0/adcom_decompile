...
class TrackGooglePurchase {
    ...
    class C13541 implements ServiceConnection {
        C13541() {
        }
    ...
    class C13552 implements Runnable {
        C13552() {
        }
    ...
    private void sendPurchases(ArrayList<String> skusToAdd, ArrayList<String> newPurchaseTokens) {
        try {
            ...
            new Bundle().putStringArrayList(IabHelper.GET_SKU_DETAILS_ITEM_LIST, skusToAdd);
            ...
            if (skuDetails.getInt("RESPONSE_CODE") == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    jsonItem.put(AppLovinEventParameters.PRODUCT_IDENTIFIER, sku);
