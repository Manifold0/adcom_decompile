...
abstract class UserState {
    ...
    private static final String[] LOCATION_FIELDS = new String[]{"lat", Constants.LONG, "loc_acc", "loc_type", "loc_bg", "loc_time_stamp", "ad_id"};
    ...
    private static final Object syncLock = new C13571();
    ...
    void setLocation(LocationPoint point) {
        try {
            ...
            this.syncValues.put(Constants.LONG, point.log);
    ...
    void clearLocation() {
        try {
            ...
            this.syncValues.put(Constants.LONG, null);
