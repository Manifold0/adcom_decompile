...
public interface IInAppBillingService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInAppBillingService {
        ...
        private static class Proxy implements IInAppBillingService {
            ...
            public int consumePurchaseExtraParams(int apiVersion, String packageName, String purchaseToken, Bundle extraParams) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    ...
                    _result2 = getBuyIntentExtraParams(_arg0, _arg1, _arg2, _arg32, _arg42, _arg5);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
                ...
                case 9:
                    ...
                    _result2 = getPurchaseHistory(_arg0, _arg1, _arg2, _arg32, _arg4);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
                ...
                case 10:
                    ...
                    _result = isBillingSupportedExtraParams(_arg0, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 11:
                    ...
                    _result2 = getPurchasesExtraParams(_arg0, _arg1, _arg2, _arg32, _arg4);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
                ...
                case 12:
                    ...
                    _result = consumePurchaseExtraParams(_arg0, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
