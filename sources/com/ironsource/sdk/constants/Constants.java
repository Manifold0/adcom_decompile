...
public class Constants {
    ...
    public static class JSMethods {
        ...
        public static JSMethods getInitMethodByProduct(ProductType type) {
            JSMethods initMethod = new JSMethods();
            if (type == ProductType.RewardedVideo) {
                initMethod.methodName = INIT_REWARDED_VIDEO;
                initMethod.successCallbackName = ON_INIT_REWARDED_VIDEO_SUCCESS;
                initMethod.failureCallbackName = ON_INIT_REWARDED_VIDEO_FAIL;
            } else if (type == ProductType.Interstitial) {
                initMethod.methodName = INIT_INTERSTITIAL;
                initMethod.successCallbackName = ON_INIT_INTERSTITIAL_SUCCESS;
                initMethod.failureCallbackName = ON_INIT_INTERSTITIAL_FAIL;
            } else if (type == ProductType.OfferWall) {
                initMethod.methodName = INIT_OFFERWALL;
                initMethod.successCallbackName = ON_INIT_OFFERWALL_SUCCESS;
                initMethod.failureCallbackName = ON_INIT_OFFERWALL_FAIL;
            }
            return initMethod;
        }

        public static JSMethods getShowMethodByProduct(ProductType type) {
            JSMethods showMethod = new JSMethods();
            if (type == ProductType.RewardedVideo) {
                showMethod.methodName = SHOW_REWARDED_VIDEO;
                showMethod.successCallbackName = ON_SHOW_REWARDED_VIDEO_SUCCESS;
                showMethod.failureCallbackName = ON_SHOW_REWARDED_VIDEO_FAIL;
            } else if (type == ProductType.Interstitial) {
                showMethod.methodName = SHOW_INTERSTITIAL;
                showMethod.successCallbackName = ON_SHOW_INTERSTITIAL_SUCCESS;
                showMethod.failureCallbackName = ON_SHOW_INTERSTITIAL_FAIL;
            } else if (type == ProductType.OfferWall) {
                showMethod.methodName = SHOW_OFFER_WALL;
                showMethod.successCallbackName = ON_SHOW_OFFER_WALL_SUCCESS;
                showMethod.failureCallbackName = ON_INIT_OFFERWALL_FAIL;
            }
            return showMethod;
        }
    }
