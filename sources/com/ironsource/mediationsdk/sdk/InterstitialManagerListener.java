...
public interface InterstitialManagerListener {
    ...
    void onInterstitialAdLoadFailed(IronSourceError ironSourceError, InterstitialSmash interstitialSmash);

    void onInterstitialAdOpened(InterstitialSmash interstitialSmash);

    void onInterstitialAdReady(InterstitialSmash interstitialSmash);
