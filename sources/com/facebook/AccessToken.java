...
public final class AccessToken implements Parcelable {
    ...
    public static final Creator<AccessToken> CREATOR = new C11492();
    ...
    static class C11492 implements Creator {
        C11492() {
        }
    ...
    public int hashCode() {
        return ((((((((((((((this.expires.hashCode() + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + this.permissions.hashCode()) * 31) + this.declinedPermissions.hashCode()) * 31) + this.token.hashCode()) * 31) + this.source.hashCode()) * 31) + this.lastRefresh.hashCode()) * 31) + (this.applicationId == null ? 0 : this.applicationId.hashCode())) * 31) + this.userId.hashCode();
    }
