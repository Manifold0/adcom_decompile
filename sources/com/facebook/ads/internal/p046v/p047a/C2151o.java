...
public class C2151o {
    /* renamed from: a */
    private static String m5506a(byte[] bArr, String str) {
    ...
    /* renamed from: a */
    public static void m5507a(HttpsURLConnection httpsURLConnection, Set<String> set, Set<String> set2) {
        if (VERSION.SDK_INT != 15 || !"4.0.3".equals(VERSION.RELEASE)) {
            try {
                ...
                while (i < length) {
                    ...
                    String a = C2151o.m5506a(x509Certificate.getEncoded(), Constants.SHA1);
                    if (set == null || !set.contains(a)) {
                        String a2 = C2151o.m5506a(x509Certificate.getPublicKey().getEncoded(), Constants.SHA1);
