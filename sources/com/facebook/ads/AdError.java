...
public class AdError {
    ...
    public static AdError getAdErrorFromWrapper(C2065a c2065a) {
        return c2065a.m5038a().isPublicError() ? new AdError(c2065a.m5038a().getErrorCode(), c2065a.m5039b()) : new AdError(AdErrorType.UNKNOWN_ERROR.getErrorCode(), AdErrorType.UNKNOWN_ERROR.getDefaultErrorMessage());
    }
