...
public class AdSettings {
    ...
    public static TestAdType getTestAdType() {
        Serializable serializable = AdInternalSettings.f4776a.getSerializable("TEST_AD_TYPE_KEY");
        if (serializable != null && (serializable instanceof TestAdType)) {
            return (TestAdType) serializable;
        }
        AdInternalSettings.f4776a.putSerializable("TEST_AD_TYPE_KEY", TestAdType.DEFAULT);
    ...
    public static boolean isChildDirected() {
        return AdInternalSettings.f4776a.getBoolean("BOOL_CHILD_DIRECTED_KEY", false);
    }
    ...
    public static void setIntegrationErrorMode(IntegrationErrorMode integrationErrorMode) {
        AdInternalSettings.f4776a.putSerializable("SRL_INTEGRATION_ERROR_MODE_KEY", integrationErrorMode);
    }

    public static void setIsChildDirected(boolean z) {
        AdInternalSettings.f4776a.putBoolean("BOOL_CHILD_DIRECTED_KEY", z);
    }
    ...
    public static void setMultiprocessSupportMode(MultiprocessSupportMode multiprocessSupportMode) {
        AdInternalSettings.f4778c = multiprocessSupportMode == MultiprocessSupportMode.MULTIPROCESS_SUPPORT_MODE_OFF;
    }

    public static void setTestAdType(TestAdType testAdType) {
        AdInternalSettings.f4776a.putSerializable("TEST_AD_TYPE_KEY", testAdType);
    }
