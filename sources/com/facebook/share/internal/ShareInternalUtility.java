...
public final class ShareInternalUtility {
    ...
    static class C03685 implements Mapper<Attachment, String> {
        C03685() {
        }
    ...
    static class C03718 implements PhotoJSONProcessor {
        C03718() {
        }
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, final UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                ...
                List<String> attachmentUrls = Utility.map(attachments, new C03685());
    ...
    public static JSONObject toJSONObjectForWeb(ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        return OpenGraphJSONUtility.toJSONObject(shareOpenGraphContent.getAction(), new C03718());
    }
