...
public class AppEventsLoggerUtility {
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = new C11941();

    /* renamed from: com.facebook.appevents.internal.AppEventsLoggerUtility$1 */
    static class C11941 extends HashMap<GraphAPIActivityType, String> {
        C11941() {
