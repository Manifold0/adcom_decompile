...
public class ToolTipPopup {
    ...
    private final OnScrollChangedListener mScrollListener = new C26941();
    private Style mStyle = Style.BLUE;
    private final String mText;

    /* renamed from: com.facebook.login.widget.ToolTipPopup$1 */
    class C26941 implements OnScrollChangedListener {
        C26941() {
        }
    ...
    class C26952 implements Runnable {
        C26952() {
        }
    ...
    class C26963 implements OnClickListener {
        C26963() {
        }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C0942R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C0942R.id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C0942R.id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C0942R.id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C0942R.id.com_facebook_button_xout);
        }
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C0942R.id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0942R.drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C0942R.drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0942R.drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C0942R.drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0942R.drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C0942R.drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0942R.drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C0942R.drawable.com_facebook_tooltip_black_xout);
            }
            ...
            if (this.mNuxDisplayTime > 0) {
                this.mPopupContent.postDelayed(new C26952(), this.mNuxDisplayTime);
            }
            this.mPopupWindow.setTouchable(true);
            this.mPopupContent.setOnClickListener(new C26963());
        }
    }
