...
*/
    ...
    private static AttributionIdentifiers getAndroidIdViaReflection(Context context) {
        try {
            ...
            Method isLimitAdTrackingEnabled = Utility.getMethodQuietly(advertisingInfo.getClass(), RequestParameters.isLAT, new Class[0]);
    ...
    private static AttributionIdentifiers getAndroidIdViaService(Context context) {
        ...
        if (context.bindService(intent, connection, 1)) {
            try {
                ...
                Utility.logd(TapjoyConstants.TJC_ANDROID_ID, exception);
            } finally {
