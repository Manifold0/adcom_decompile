...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C03021 implements OnCompleteListener {
        C03021() {
        }
    ...
    class C03032 implements OnCompleteListener {
        C03032() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C03032());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C03021()).build();
            }
