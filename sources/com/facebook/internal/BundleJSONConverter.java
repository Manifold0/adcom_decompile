...
public class BundleJSONConverter {
    ...
    static class C11981 implements Setter {
        C11981() {
        }
    ...
    static class C11992 implements Setter {
        C11992() {
        }
    ...
    static class C12003 implements Setter {
        C12003() {
        }
    ...
    static class C12014 implements Setter {
        C12014() {
        }
    ...
    static class C12025 implements Setter {
        C12025() {
        }
    ...
    static class C12036 implements Setter {
        C12036() {
        }
    ...
    static class C12047 implements Setter {
        C12047() {
        }
    ...
    static {
        SETTERS.put(Boolean.class, new C11981());
        SETTERS.put(Integer.class, new C11992());
        SETTERS.put(Long.class, new C12003());
        SETTERS.put(Double.class, new C12014());
        SETTERS.put(String.class, new C12025());
        SETTERS.put(String[].class, new C12036());
        SETTERS.put(JSONArray.class, new C12047());
    }
