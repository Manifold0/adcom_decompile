...
public class ImageRequest {
    ...
    public static Uri getProfilePictureUri(String userId, int width, int height) {
        ...
        android.net.Uri.Builder builder = Uri.parse(ServerProtocol.getGraphUrlBase()).buildUpon().path(String.format(Locale.US, PATH, new Object[]{FacebookSdk.getGraphApiVersion(), userId}));
        if (height != 0) {
