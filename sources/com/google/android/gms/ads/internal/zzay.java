                    ...
                    try {
                        ...
                        if (zzca != null) {
                            ...
                            if (!zzpe.isInitialized() && zzpe.zzms()) {
                                ...
                                zzakb.zzck(valueOf2.length() != 0 ? str3.concat(valueOf2) : new String(str3));
                            }
                        }
                    } catch (Throwable th2) {
                        zzakb.zzc(new StringBuilder(String.valueOf(str2).length() + 56).append("Failed to initialize rewarded video mediation adapter \"").append(str2).append("\"").toString(), th2);
                    }
                }
            }
        }
