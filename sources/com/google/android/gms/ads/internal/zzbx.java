...
public final class zzbx extends ViewSwitcher {
    ...
    public final void zzfs() {
        zzakb.m3915v("Disable position monitoring on adFrame.");
        if (this.zzaee != null) {
            this.zzaee.zzsd();
        }
    }
    ...
    public final void zzft() {
        zzakb.m3915v("Enable debug gesture detector on adFrame.");
        this.zzaef = true;
    }

    public final void zzfu() {
        zzakb.m3915v("Disable debug gesture detector on adFrame.");
        this.zzaef = false;
    }
}
