...
public class GcmPubSub {
    ...
    private static final Pattern zzhzf = Pattern.compile("/topics/[a-zA-Z0-9-_.~%]{1,900}");
    ...
    public void subscribe(String str, String str2, Bundle bundle) throws IOException {
        ...
        if (str == null || str.isEmpty()) {
        ...
        } else if (str2 == null || !zzhzf.matcher(str2).matches()) {
            ...
            this.zzhze.getToken(str, str2, bundle);
        }
    }
    ...
    public void unsubscribe(String str, String str2) throws IOException {
        ...
        bundle.putString("gcm.topic", str2);
        this.zzhze.zza(str, str2, bundle);
    }
}
