...
import com.google.android.gms.C0946R;
...
final class zza {
    ...
    static synchronized zza zzdg(Context context) {
        zza zza;
        synchronized (zza.class) {
            if (zzhzb == null) {
                zzhzb = new zza(context);
            }
            zza = zzhzb;
        }
        return zza;
    ...
    static boolean zzdh(Context context) {
            ...
            if (zzq.isAtLeastO() || this.mContext.getApplicationInfo().targetSdkVersion <= 25) {
                ...
                if (zzq.isAtLeastO()) {
                    ...
                    if (this.zzhzc != null) {
                        ...
                        this.zzhzc = zzaui().getString("com.google.android.gms.gcm.default_notification_channel_id");
                        if (TextUtils.isEmpty(this.zzhzc)) {
                            Log.w("GcmNotification", "Missing Default Notification Channel metadata in AndroidManifest. Default value will be used.");
                        } else if (notificationManager.getNotificationChannel(this.zzhzc) != null) {
                            str = this.zzhzc;
                        } else {
                        ...
                        if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                            notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.mContext.getString(C0946R.string.gcm_fallback_notification_channel_label), 3));
                        }
