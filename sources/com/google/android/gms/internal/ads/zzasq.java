...
final class zzasq extends zzasv implements OnGlobalLayoutListener, DownloadListener, zzaqw, zzuo {
    ...
    protected final synchronized void onMeasure(int i, int i2) {
        if (isDestroyed()) {
            ...
            if (obj != null) {
                zzakb.zzdk("Not enough space to show ad. Needs " + ((int) (((float) this.zzddh.widthPixels) / this.zzdeu)) + "x" + ((int) (((float) this.zzddh.heightPixels) / this.zzdeu)) + " dp, but only has " + ((int) (((float) size3) / this.zzdeu)) + "x" + ((int) (((float) size4) / this.zzdeu)) + " dp.");
                if (getVisibility() != 8) {
                    setVisibility(4);
                }
                setMeasuredDimension(0, 0);
