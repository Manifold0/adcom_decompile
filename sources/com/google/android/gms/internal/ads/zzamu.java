...
public final class zzamu {
    ...
    public static String zzbc(Context context) {
        ...
        String string = contentResolver == null ? null : Secure.getString(contentResolver, TapjoyConstants.TJC_ANDROID_ID);
        if (string == null || zzsg()) {
            string = "emulator";
        }
        return zzde(string);
    ...
    public static String zzbd(Context context) {
        ContentResolver contentResolver = context.getContentResolver();
        return contentResolver == null ? null : Secure.getString(contentResolver, TapjoyConstants.TJC_ANDROID_ID);
    }
