...
import com.google.android.gms.ads.C0947R;
...
public final class zzjq {
    ...
    public zzjq(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0947R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0947R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0947R.styleable.AdsAttrs_adSizes);
        ...
        this.zzye = obtainAttributes.getString(C0947R.styleable.AdsAttrs_adUnitId);
