...
public final class zzarl extends zzlp {
        ...
        synchronized (this.lock) {
            ...
            if (z7) {
                try {
                    ...
                    zzakb.zzc("Unable to call onVideoPause()", e22);
                }
            }
            if (z8) {
                try {
                    ...
                    zzakb.zzc("Unable to call onVideoEnd()", e222);
                }
            }
            if (z4) {
                try {
                    ...
                    zzakb.zzc("Unable to call onVideoMute()", e2222);
                }
            }
        }
    }
    ...
    public final void zzb(zzmu zzmu) {
        ...
        zzf("initialState", CollectionUtils.mapOf("muteStart", zzmu.zzato ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO, "customControlsRequested", zzmu.zzatp ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO, "clickToExpandRequested", zzmu.zzatq ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO));
    }
