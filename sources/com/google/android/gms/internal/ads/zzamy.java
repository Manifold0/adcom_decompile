...
public final class zzamy {
                ...
                if (!zzcuy.contains(str)) {
                    if (!(entry.getValue() instanceof List)) {
                        if (!(entry.getValue() instanceof String)) {
                            zzane.m1665e("Connection headers should be either Map<String, String> or Map<String, List<String>>");
                            break;
                        }
    ...
    private static synchronized void zzdi(String str) {
        synchronized (zzamy.class) {
            ...
            for (int i = 0; i < str.length(); i += GamesStatusCodes.STATUS_SNAPSHOT_NOT_FOUND) {
                String str2 = "GMA Debug CONTENT ";
                String valueOf = String.valueOf(str.substring(i, Math.min(i + GamesStatusCodes.STATUS_SNAPSHOT_NOT_FOUND, str.length())));
