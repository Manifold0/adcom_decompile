...
public final class zzapi extends FrameLayout implements zzapf {
    ...
    public final void zzsv() {
        if (this.zzcxr != null && this.zzcxx == 0) {
            ...
            zza("canplaythrough", "duration", String.valueOf(duration), String.VIDEO_WIDTH, String.valueOf(videoWidth), String.VIDEO_HEIGHT, String.valueOf(videoHeight));
        }
    }
    ...
    public final void zzsz() {
        ...
        if (this.zzcxz != null) {
            ...
            if (zzakb.zzqp()) {
                zzakb.m3915v("Spinner frame grab took " + elapsedRealtime + "ms");
            }
    ...
    final void zzte() {
        if (this.zzcxr != null) {
            ...
            if (this.zzcxw != currentPosition && currentPosition > 0) {
                ...
                zza("timeupdate", LocationConst.TIME, String.valueOf(f));
