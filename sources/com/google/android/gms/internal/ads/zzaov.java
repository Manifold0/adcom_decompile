...
public final class zzaov extends zzapg implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    static {
        if (VERSION.SDK_INT >= 17) {
            zzcwo.put(Integer.valueOf(IabHelper.IABHELPER_SEND_INTENT_FAILED), "MEDIA_ERROR_IO");
            zzcwo.put(Integer.valueOf(IabHelper.IABHELPER_MISSING_TOKEN), "MEDIA_ERROR_MALFORMED");
            zzcwo.put(Integer.valueOf(IabHelper.IABHELPER_INVALID_CONSUMPTION), "MEDIA_ERROR_UNSUPPORTED");
            zzcwo.put(Integer.valueOf(FetchConst.ERROR_SERVER_ERROR), "MEDIA_ERROR_TIMED_OUT");
        ...
        zzcwo.put(Integer.valueOf(AppLovinSdk.VERSION_CODE), "MEDIA_INFO_NOT_SEEKABLE");
        zzcwo.put(Integer.valueOf(802), "MEDIA_INFO_METADATA_UPDATE");
        if (VERSION.SDK_INT >= 19) {
            zzcwo.put(Integer.valueOf(FetchConst.STATUS_DOWNLOADING), "MEDIA_INFO_UNSUPPORTED_SUBTITLE");
            zzcwo.put(Integer.valueOf(FetchConst.STATUS_PAUSED), "MEDIA_INFO_SUBTITLE_TIMED_OUT");
        }
    }
    ...
    private final void zzag(boolean z) {
        zzakb.m3915v("AdMediaPlayerView release");
        if (this.zzcxa != null) {
            this.zzcxa.zzti();
            this.zzcxa = null;
        }
    ...
    private final void zzsq() {
        Throwable e;
        String valueOf;
        zzakb.m3915v("AdMediaPlayerView init MediaPlayer");
    ...
    private final void zzsr() {
        if (this.zzcwq && zzss() && this.zzcwt.getCurrentPosition() > 0 && this.zzcws != 3) {
            zzakb.m3915v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzcwt.start();
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        zzakb.m3915v("AdMediaPlayerView completion");
        zzag(5);
        this.zzcws = 5;
    ...
    public final boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        String str = (String) zzcwo.get(Integer.valueOf(i));
        String str2 = (String) zzcwo.get(Integer.valueOf(i2));
        zzakb.m3915v(new StringBuilder((String.valueOf(str).length() + 37) + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        zzakb.m3915v("AdMediaPlayerView prepared");
        zzag(2);
        this.zzcwp.zzsv();
        ...
        zzsr();
        int i = this.zzcwv;
        zzakb.zzdj("AdMediaPlayerView stream dimensions: " + i + " x " + this.zzcww);
        if (this.zzcws == 3) {
            play();
        }
        zzst();
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzakb.m3915v("AdMediaPlayerView surface created");
        zzsq();
        zzakk.zzcrm.post(new zzapa(this));
    }

    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzakb.m3915v("AdMediaPlayerView surface destroyed");
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        Object obj = 1;
        zzakb.m3915v("AdMediaPlayerView surface changed");
    ...
    public final void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzakb.m3915v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzcwv = mediaPlayer.getVideoWidth();
        this.zzcww = mediaPlayer.getVideoHeight();
    ...
    protected final void onWindowVisibilityChanged(int i) {
        zzakb.m3915v("AdMediaPlayerView window visibility changed to " + i);
        zzakk.zzcrm.post(new zzaow(this, i));
        super.onWindowVisibilityChanged(i);
    }

    public final void pause() {
        zzakb.m3915v("AdMediaPlayerView pause");
    ...
    public final void play() {
        zzakb.m3915v("AdMediaPlayerView play");
        if (zzss()) {
            this.zzcwt.start();
            zzag(3);
            this.zzcxk.zzsw();
    ...
    public final void seekTo(int i) {
        zzakb.m3915v("AdMediaPlayerView seek " + i);
        if (zzss()) {
            this.zzcwt.seekTo(i);
            this.zzcxc = 0;
            return;
    ...
    public final void stop() {
        zzakb.m3915v("AdMediaPlayerView stop");
        if (this.zzcwt != null) {
            this.zzcwt.stop();
            this.zzcwt.release();
            this.zzcwt = null;
