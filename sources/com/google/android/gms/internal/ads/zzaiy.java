...
public final class zzaiy {
    ...
    private final void zza(Exception exception, String str, boolean z) {
        if (!this.zzcns.get()) {
            zzakb.zzdk(new StringBuilder(String.valueOf(str).length() + 30).append("Invoke Firebase method ").append(str).append(" error.").toString());
            if (z) {
    ...
    private final void zzb(Context context, String str, String str2) {
        if (zza(context, "com.google.android.gms.measurement.AppMeasurement", this.zzcnu, true)) {
            ...
            try {
                ...
                zzakb.m3915v(new StringBuilder((String.valueOf(str2).length() + 37) + String.valueOf(str).length()).append("Invoke Firebase method ").append(str2).append(", Ad Unit Id: ").append(str).toString());
            } catch (Exception e) {
                zza(e, str2, false);
            }
        }
    ...
    public final void zza(Context context, String str, String str2, String str3, int i) {
        if (zzs(context)) {
            ...
            zza.putInt("value", i);
            zza(context, "_ar", zza);
            zzakb.m3915v(new StringBuilder(String.valueOf(str3).length() + 75).append("Log a Firebase reward video event, reward type: ").append(str3).append(", reward value: ").append(i).toString());
        }
    }
