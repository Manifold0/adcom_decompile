...
public final class zzajb {
    ...
    private static Uri zzb(String str, String str2, String str3) {
        ...
        return indexOf != -1 ? Uri.parse(new StringBuilder(str.substring(0, indexOf + 1)).append(str2).append(RequestParameters.EQUAL).append(str3).append(RequestParameters.AMPERSAND).append(str.substring(indexOf + 1)).toString()) : Uri.parse(str).buildUpon().appendQueryParameter(str2, str3).build();
    }
