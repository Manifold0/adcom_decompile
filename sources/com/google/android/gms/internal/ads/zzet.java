...
public final class zzet implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    private final JSONObject zzgg() throws JSONException {
        ...
        jSONObject.put("afmaVersion", this.zzaet.zzfw()).put("activeViewJSON", this.zzaet.zzfx()).put("timestamp", zzbv.zzer().elapsedRealtime()).put("adFormat", this.zzaet.zzfv()).put("hashCode", this.zzaet.zzfy()).put("isMraid", this.zzaet.zzfz()).put("isStopped", this.zzafa).put("isPaused", this.zzaaq).put("isNative", this.zzaet.zzga()).put("isScreenOn", isScreenOn()).put("appMuted", zzbv.zzfj().zzdp()).put("appVolume", (double) zzbv.zzfj().zzdo()).put(RequestParameters.DEVICE_VOLUME, (double) this.zzafj);
        return jSONObject;
    }
        ...
        synchronized (this.mLock) {
            if (this.zzafb) {
                ...
                try {
                    ...
                    zzakb.zzb("JSON failure while processing active view data.", e);
                } catch (Throwable e2) {
                    zzakb.zzb("Failure while processing active view data.", e2);
                }
    ...
    L_0x00cc:
        ...
        com.google.android.gms.internal.ads.zzakb.zza(r1, r0);	 Catch:{ all -> 0x005d }
        goto L_0x008c;
    L_0x00d2:
        r0 = move-exception;
        goto L_0x00cc;
