...
final class zzari extends WebView implements OnGlobalLayoutListener, DownloadListener, zzaqw {
    ...
    public final synchronized void destroy() {
        ...
        if (!this.zzddj) {
            ...
            zzvn();
            this.zzddj = true;
            zzakb.m3915v("Initiating WebView self destruct sequence in 3...");
            zzakb.m3915v("Loading blank page in WebView, 2...");
            zzdt("about:blank");
        }
    }
    ...
    protected final synchronized void onMeasure(int i, int i2) {
        if (isDestroyed()) {
            ...
            if (obj != null) {
                zzakb.zzdk("Not enough space to show ad. Needs " + ((int) (((float) this.zzddh.widthPixels) / this.zzddc)) + "x" + ((int) (((float) this.zzddh.heightPixels) / this.zzddc)) + " dp, but only has " + ((int) (((float) size3) / this.zzddc)) + "x" + ((int) (((float) size4) / this.zzddc)) + " dp.");
                if (getVisibility() != 8) {
                    setVisibility(4);
                }
                setMeasuredDimension(0, 0);
    ...
    public final synchronized void zzuk() {
        zzakb.m3915v("Destroying WebView!");
        zzqf();
    ...
    public final void zzus() {
        zzakb.m3915v("Cannot add text view to inner AdWebView");
    }
}
