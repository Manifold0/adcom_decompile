...
public final class zzaan {
    ...
    L_0x001d:
        monitor-exit(r1);	 Catch:{ all -> 0x002d }
        r0 = r7.zzbxh;	 Catch:{ RemoteException -> 0x0038, NullPointerException -> 0x0030 }
        r2 = com.google.android.gms.dynamic.ObjectWrapper.wrap(r9);	 Catch:{ RemoteException -> 0x0038, NullPointerException -> 0x0030 }
        r1 = r8;
        r3 = r10;
        r4 = r11;
        r5 = r12;
    ...
    L_0x001b:
        monitor-exit(r1);	 Catch:{ all -> 0x002d }
        r0 = r3.zzbxh;	 Catch:{ RemoteException -> 0x0026, NullPointerException -> 0x0030 }
        r1 = com.google.android.gms.dynamic.ObjectWrapper.wrap(r5);	 Catch:{ RemoteException -> 0x0026, NullPointerException -> 0x0030 }
    ...
    public final void zzm(com.google.android.gms.dynamic.IObjectWrapper r4) {
        ...
        r1 = sLock;
        monitor-enter(r1);
        r0 = com.google.android.gms.internal.ads.zznk.zzbet;	 Catch:{ all -> 0x0029 }
        r2 = com.google.android.gms.internal.ads.zzkb.zzik();	 Catch:{ all -> 0x0029 }
        r0 = r2.zzd(r0);	 Catch:{ all -> 0x0029 }
        r0 = (java.lang.Boolean) r0;	 Catch:{ all -> 0x0029 }
        r0 = r0.booleanValue();	 Catch:{ all -> 0x0029 }
        if (r0 == 0) goto L_0x0019;
    L_0x0015:
        r0 = zzsh;	 Catch:{ all -> 0x0029 }
        if (r0 != 0) goto L_0x001b;
    L_0x0019:
    ...
    L_0x001b:
        monitor-exit(r1);	 Catch:{ all -> 0x0029 }
        r0 = r3.zzbxh;	 Catch:{ RemoteException -> 0x0022, NullPointerException -> 0x002c }
