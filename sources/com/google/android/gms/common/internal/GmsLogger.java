...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void m1d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void m2d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void m7v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void m8v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void m5i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void m6i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void m9w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void m10w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void m3e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void m4e(String str, String str2, Throwable th) {
        if (canLog(6)) {
