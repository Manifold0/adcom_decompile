...
public final class Objects {
    ...
    public static final class ToStringHelper {
        ...
        public final ToStringHelper add(String str, @Nullable Object obj) {
            ...
            list.add(new StringBuilder((String.valueOf(str2).length() + 1) + String.valueOf(valueOf).length()).append(str2).append(RequestParameters.EQUAL).append(valueOf).toString());
            return this;
        }
