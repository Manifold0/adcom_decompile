...
public class NumberedThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(Runnable runnable) {
        ...
        newThread.setName(new StringBuilder(String.valueOf(str).length() + 13).append(str).append(RequestParameters.LEFT_BRACKETS).append(this.zzht.getAndIncrement()).append(RequestParameters.RIGHT_BRACKETS).toString());
        return newThread;
    }
}
