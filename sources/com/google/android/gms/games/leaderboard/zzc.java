...
public final class zzc extends DataBufferRef implements LeaderboardVariant {
    ...
    public final long getNumScores() {
        return hasNull("total_scores") ? -1 : getLong("total_scores");
    }

    public final long getPlayerRank() {
        return hasNull("player_rank") ? -1 : getLong("player_rank");
    }
    ...
    public final long getRawPlayerScore() {
        return hasNull("player_raw_score") ? -1 : getLong("player_raw_score");
    }
