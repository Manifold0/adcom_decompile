...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        ...
        long j = this.zzf;
        return new StringBuilder(String.valueOf(valueOf).length() + MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES).append("ActivityRecognitionResult [probableActivities=").append(valueOf).append(", timeMillis=").append(j).append(", elapsedRealtimeMillis=").append(this.zzg).append(RequestParameters.RIGHT_BRACKETS).toString();
    }
