...
public class DetectedActivity extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(str).length() + 48).append("DetectedActivity [type=").append(str).append(", confidence=").append(this.zzs).append(RequestParameters.RIGHT_BRACKETS).toString();
    }
