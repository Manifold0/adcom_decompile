...
public class FirebaseApp {
    ...
    private FirebaseApp(Context applicationContext, String name, FirebaseOptions options) {
        ...
        Iterable zza = C10401.zza(applicationContext).zza();
        this.zzl = new zzf(zzh, zza, Component.of(applicationContext, Context.class, new Class[0]), Component.of(this, FirebaseApp.class, new Class[0]), Component.of(options, FirebaseOptions.class, new Class[0]));
