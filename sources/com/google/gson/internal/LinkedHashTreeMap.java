...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C33831();
    ...
    static class C33831 implements Comparator<Comparable> {
        C33831() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C33841 extends LinkedTreeMapIterator<Entry<K, V>> {
            C33841() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C33851 extends LinkedTreeMapIterator<K> {
            C33851() {
                super();
            }
