...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C33861();
    ...
    static class C33861 implements Comparator<Comparable> {
        C33861() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C33871 extends LinkedTreeMapIterator<Entry<K, V>> {
            C33871() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C33881 extends LinkedTreeMapIterator<K> {
            C33881() {
                super();
            }
