...
public final class Fetch implements FetchConst {
    private static final Callback callsCallback = new C10791();
    ...
    private final BroadcastReceiver networkReceiver = new C10835();
    private final BroadcastReceiver updateReceiver = new C10824();

    /* renamed from: com.tonyodev.fetch.Fetch$1 */
    static class C10791 implements Callback {
        C10791() {
        }
    ...
    /* renamed from: com.tonyodev.fetch.Fetch$4 */
    class C10824 extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                try {
                    Iterator<FetchListener> listenerIterator = Fetch.this.getListenerIterator();
    ...
    /* renamed from: com.tonyodev.fetch.Fetch$5 */
    class C10835 extends BroadcastReceiver {
        C10835() {
        }
    ...
    public long enqueue(@NonNull Request request) {
        ...
        try {
            ...
            if (this.dbHelper.insert(id, url, filePath, FetchConst.STATUS_QUEUED, headers, downloadedBytes, 0, priority, -1)) {
                startService(this.context);
                return id;
            }
    ...
    public long addCompletedDownload(@NonNull String filePath) {
        ...
        try {
            ...
            throw new EnqueueException("File does not exist at filePath: " + filePath, -102);
        } catch (EnqueueException e) {
            if (isLoggingEnabled()) {
                e.printStackTrace();
            }
