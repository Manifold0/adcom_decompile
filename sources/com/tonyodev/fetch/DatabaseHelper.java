...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tonyodev.fetch.DatabaseHelper.insert(java.lang.String):boolean. bs: [B:8:0x0016, B:29:0x0056]
...
*/
    ...
    L_0x0026:
        r3 = new com.tonyodev.fetch.exception.EnqueueException;	 Catch:{ all -> 0x0038 }
        r4 = r0.getMessage();	 Catch:{ all -> 0x0038 }
        r5 = r0.getMessage();	 Catch:{ all -> 0x0038 }
        r5 = com.tonyodev.fetch.ErrorUtils.getCode(r5);	 Catch:{ all -> 0x0038 }
    ...
    L_0x0043:
        r3 = new com.tonyodev.fetch.exception.EnqueueException;	 Catch:{ all -> 0x0055 }
        r4 = r0.getMessage();	 Catch:{ all -> 0x0055 }
        r5 = r0.getMessage();	 Catch:{ all -> 0x0055 }
        r5 = com.tonyodev.fetch.ErrorUtils.getCode(r5);	 Catch:{ all -> 0x0055 }
    ...
    L_0x0065:
        ...
        throw r3;	 Catch:{ all -> 0x0038 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tonyodev.fetch.DatabaseHelper.insert(java.lang.String):boolean");
    }
