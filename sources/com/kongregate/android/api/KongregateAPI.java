...
public interface KongregateAPI {
    ...
    void addEventBundleListener(KongregateEventBundleListener kongregateEventBundleListener);
    ...
    void onPause(Activity activity, Map<String, Object> map);

    void onResume(Activity activity);

    void onResume(Activity activity, String str);

    void onResume(Activity activity, Map<String, Object> map);

    List<KongregateEventBundle> pollEventBundles();

    List<String> pollEvents();

    void removeEventBundleListener(KongregateEventBundleListener kongregateEventBundleListener);
