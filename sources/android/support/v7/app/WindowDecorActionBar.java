...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C16641();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C16652();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C16663();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C16641 extends ViewPropertyAnimatorListenerAdapter {
        C16641() {
        }
    ...
    class C16652 extends ViewPropertyAnimatorListenerAdapter {
        C16652() {
        }
    ...
    class C16663 implements ViewPropertyAnimatorUpdateListener {
        C16663() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0930R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0930R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0930R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0930R.id.action_bar_container);
        ...
        if (a.getBoolean(C0930R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0930R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0930R.attr.actionBarWidgetTheme, outValue, true);
