...
public class PopupMenu {
    ...
    class C16961 implements Callback {
        C16961() {
        }
    ...
    class C16972 implements android.widget.PopupWindow.OnDismissListener {
        C16972() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0930R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C16961());
        ...
        this.mPopup.setOnDismissListener(new C16972());
    }
