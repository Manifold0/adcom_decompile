...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0930R.layout.tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0930R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0930R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int offsetBelow;
        int offsetAbove;
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0930R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra = this.mContext.getResources().getDimensionPixelOffset(C0930R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0930R.dimen.tooltip_y_offset_touch : C0930R.dimen.tooltip_y_offset_non_touch);
        ...
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            ...
            int resourceId = res.getIdentifier("status_bar_height", "dimen", TapjoyConstants.TJC_DEVICE_PLATFORM_TYPE);
            if (resourceId != 0) {
