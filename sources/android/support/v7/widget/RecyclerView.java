...
import android.support.v7.recyclerview.C0932R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C26663();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C26701();
        ...
        private final Callback mVerticalBoundCheckCallback = new C26712();
        private int mWidth;
        ...
        class C26701 implements Callback {
            C26701() {
            }
        ...
        class C26712 implements Callback {
            C26712() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0932R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0932R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0932R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0932R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0932R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C26641 implements Runnable {
        C26641() {
        }
    ...
    class C26652 implements Runnable {
        C26652() {
        }
    ...
    static class C26663 implements Interpolator {
        C26663() {
        }
    ...
    class C26674 implements ProcessCallback {
        C26674() {
        }
    ...
    class C26685 implements Callback {
        C26685() {
        }
    ...
    class C26696 implements Callback {
        C26696() {
        }
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                if (forceRecycle || holder.isRecyclable()) {
                    if (this.mViewCacheMax > 0 && !holder.hasAnyOfTheFlags(IronSourceError.ERROR_CAPPED_PER_SESSION)) {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C26721());
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C26721 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C26721() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C26641();
        ...
        this.mItemAnimatorRunner = new C26652();
        this.mViewInfoProcessCallback = new C26674();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0932R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0932R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0932R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C26685());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C26696());
    }
