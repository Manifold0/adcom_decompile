...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0930R.attr.actionBarSize, 16842841};
    ...
    class C16781 extends AnimatorListenerAdapter {
        C16781() {
        }
    ...
    class C16803 implements Runnable {
        C16803() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C16781();
        this.mRemoveActionBarHideOffset = new C16792();
        this.mAddActionBarHideOffset = new C16803();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0930R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0930R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0930R.id.action_bar));
        }
    }
