...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C17023 implements OnFocusChangeListener {
        C17023() {
        }
    ...
    class C17034 implements OnLayoutChangeListener {
        C17034() {
        }
    ...
    class C17045 implements OnClickListener {
        C17045() {
        }
    ...
    class C17056 implements OnKeyListener {
        C17056() {
        }
    ...
    class C17067 implements OnEditorActionListener {
        C17067() {
        }
    ...
    class C17078 implements OnItemClickListener {
        C17078() {
        }
    ...
    class C17089 implements OnItemSelectedListener {
        C17089() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C17091();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C17091 implements ClassLoaderCreator<SavedState> {
            C17091() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        class C17101 implements Runnable {
            C17101() {
            }
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0930R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C17101();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0930R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C17001();
        this.mReleaseCursorRunnable = new C17012();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C17045();
        this.mTextKeyListener = new C17056();
        this.mOnEditorActionListener = new C17067();
        this.mOnItemClickListener = new C17078();
        this.mOnItemSelectedListener = new C17089();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0930R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0930R.styleable.SearchView_layout, C0930R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0930R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0930R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0930R.id.search_plate);
        this.mSubmitArea = findViewById(C0930R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0930R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0930R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0930R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0930R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0930R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0930R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0930R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0930R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0930R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0930R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0930R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0930R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0930R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0930R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0930R.styleable.SearchView_suggestionRowLayout, C0930R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0930R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C17023());
        setIconifiedByDefault(a.getBoolean(C0930R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0930R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0930R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0930R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0930R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0930R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0930R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C17034());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0930R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0930R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0930R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0930R.dimen.abc_dropdownitem_text_padding_left) : 0;
