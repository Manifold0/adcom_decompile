...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C26471();
            ...
            class C26471 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem msg = C26481.this.mQueue.next();
                    while (msg != null) {
                        switch (msg.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C26491();
            ...
            class C26491 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C26502.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C26502.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C26502.this.mQueue.removeMessages(2);
                                    C26502.this.mQueue.removeMessages(3);
                        ...
                        C26502.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
