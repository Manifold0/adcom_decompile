...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C26442();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C26431();
    ...
    class C26431 implements MainThreadCallback<T> {
        C26431() {
        }
    ...
    class C26442 implements BackgroundCallback<T> {
