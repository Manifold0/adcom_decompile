...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C17342();
    public static final AbsSavedState EMPTY_STATE = new C17331();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C17331 extends AbsSavedState {
        C17331() {
            super();
        }
    }
    ...
    static class C17342 implements ClassLoaderCreator<AbsSavedState> {
        C17342() {
        }
