...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C17381();
    ...
    private static final Interpolator sInterpolator = new C17392();
    ...
    private final Runnable mEndScrollRunnable = new C17403();
    ...
    static class C17381 implements Comparator<ItemInfo> {
        C17381() {
        }
    ...
    static class C17392 implements Interpolator {
        C17392() {
        }
    ...
    class C17403 implements Runnable {
        C17403() {
        }
    ...
    class C17414 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C17421();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C17421 implements ClassLoaderCreator<SavedState> {
            C17421() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C17414());
    }
