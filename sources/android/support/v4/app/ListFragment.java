...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C02952();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C02941();
    ...
    class C02952 implements OnItemClickListener {
        C02952() {
        }
