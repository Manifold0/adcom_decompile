...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        /* renamed from: b */
        private android.app.Notification.Builder f1517b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f1517b, action));
        }
        ...
        public Notification build() {
            ...
            this.f1517b.setExtras(this.mExtras);
            Notification notification = this.f1517b.build();
