...
public final class SearchViewCompat {
    ...
    public static void setSearchableInfo(View searchView, ComponentName searchableComponent) {
        ...
        ((SearchView) searchView).setSearchableInfo(((SearchManager) searchView.getContext().getSystemService(AppLovinEventTypes.USER_EXECUTED_SEARCH)).getSearchableInfo(searchableComponent));
    }
