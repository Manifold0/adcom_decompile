...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C10001 implements StyleExtractor<FontInfo> {
        C10001() {
        }
    ...
    class C10012 implements StyleExtractor<FontFileResourceEntry> {
        C10012() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C10001());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C10012());
    }
