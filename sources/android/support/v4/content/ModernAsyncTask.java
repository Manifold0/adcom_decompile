...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C09941();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C09952();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C09941 implements ThreadFactory {
    ...
    class C09952 extends WorkerRunnable<Params, Result> {
        C09952() {
        }
