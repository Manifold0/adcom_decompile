...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C11461();
    ...
    static class C11461 implements Creator<PlaybackStateCompat> {
        C11461() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C11471();
        ...
        static class C11471 implements Creator<CustomAction> {
            C11471() {
            }
