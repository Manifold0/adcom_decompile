...
public class CheckUpdateTask extends AsyncTask<Void, String, JSONArray> {
    ...
    protected String getURLString(String format) {
        ...
        if (!TextUtils.isEmpty(Secure.getString(this.context.getContentResolver(), TapjoyConstants.TJC_ANDROID_ID))) {
            builder.append("&udid=" + encodeParam(Secure.getString(this.context.getContentResolver(), TapjoyConstants.TJC_ANDROID_ID)));
        }
