...
public class SendFeedbackTask extends ConnectionTask<Void, Void, HashMap<String, String>> {
    ...
    protected void onPreExecute() {
        String loadingMessage = this.mContext.getString(C0982R.string.hockeyapp_feedback_sending_feedback_text);
        if (this.mIsFetchMessages) {
            loadingMessage = this.mContext.getString(C0982R.string.hockeyapp_feedback_fetching_feedback_text);
        }
    ...
    protected void onPostExecute(HashMap<String, String> result) {
        ...
        if (this.mHandler != null) {
            ...
            if (result != null) {
                ...
                bundle.putString(BUNDLE_FEEDBACK_RESPONSE, (String) result.get(ServerResponseWrapper.RESPONSE_FIELD));
    ...
    private HashMap<String, String> doPostPut() {
        ...
        try {
            ...
            parameters.put(TapjoyConstants.TJC_DEVICE_OS_VERSION_NAME, Constants.ANDROID_VERSION);
            ...
            result.put(ServerResponseWrapper.RESPONSE_FIELD, ConnectionTask.getStringFromConnection(urlConnection));
