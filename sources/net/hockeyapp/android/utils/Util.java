...
public class Util {
    ...
    private static final ThreadLocal<DateFormat> DATE_FORMAT_THREAD_LOCAL = new C00531();
    ...
    static class C00531 extends ThreadLocal<DateFormat> {
        C00531() {
        }
    ...
    public static String getFormString(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        for (String key : params.keySet()) {
            ...
            protoList.add(key2 + RequestParameters.EQUAL + URLEncoder.encode(value, "UTF-8"));
        }
        return TextUtils.join(RequestParameters.AMPERSAND, protoList);
    }
    ...
    public static String getAppName(Context context) {
        ...
        if (applicationInfo != null) {
            ...
            appTitle = context.getString(C0982R.string.hockeyapp_crash_dialog_app_name_fallback);
        }
        return appTitle;
    }
