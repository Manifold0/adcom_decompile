...
public class UpdateFragment extends DialogFragment implements OnClickListener, UpdateInfoListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(C0982R.id.label_title)).setText(getAppName());
        final TextView versionLabel = (TextView) view.findViewById(C0982R.id.label_version);
            ...
            AsyncTaskUtils.execute(new GetFileSizeTask(getActivity(), this.mUrlString, new DownloadFileListener() {
                public void downloadSuccessful(DownloadFileTask task) {
                    if (task instanceof GetFileSizeTask) {
                        ...
                        versionLabel.setText(UpdateFragment.this.getString(C0982R.string.hockeyapp_update_version_details_label, new Object[]{str, fileDate, appSizeString}));
                    }
                }
            }));
        }
        ...
        ((Button) view.findViewById(C0982R.id.button_update)).setOnClickListener(this);
        WebView webView = (WebView) view.findViewById(C0982R.id.web_update_details);
    ...
    public View getLayoutView() {
        ...
        LayoutInflater.from(getActivity()).inflate(C0982R.layout.hockeyapp_fragment_update, layout);
        return layout;
    }
}
