...
public class PaintView extends ImageView {
    ...
    class C00591 extends AsyncTask<Object, Void, Bitmap> {
        C00591() {
        }
    ...
    public PaintView(Context context, Uri imageUri, int displayWidth, int displayHeight) {
        ...
        new C00591().execute(new Object[]{context, imageUri, Integer.valueOf(displayWidth), Integer.valueOf(displayHeight)});
    }
