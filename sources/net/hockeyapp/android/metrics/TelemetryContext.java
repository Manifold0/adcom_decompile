...
class TelemetryContext {
    ...
    protected void configDeviceContext() {
        ...
        setOsName(com.ironsource.sdk.constants.Constants.JAVASCRIPT_INTERFACE_NAME);
        ...
        if (((TelephonyManager) this.mContext.getSystemService(PlaceFields.PHONE)).getPhoneType() != 0) {
            setDeviceType("Phone");
        } else {
