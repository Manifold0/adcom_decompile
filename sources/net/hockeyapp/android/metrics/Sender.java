...
public class Sender {
    ...
    class C00371 extends AsyncTask<Void, Void, Void> {
        C00371() {
        }
    ...
    protected void triggerSending() {
        if (requestCount() < 10) {
            try {
                AsyncTaskUtils.execute(new C00371());
                return;
            } catch (Throwable e) {
    ...
    protected boolean isRecoverableError(int responseCode) {
        return Arrays.asList(new Integer[]{Integer.valueOf(408), Integer.valueOf(429), Integer.valueOf(TJAdUnitConstants.DEFAULT_VOLUME_CHECK_INTERVAL), Integer.valueOf(503), Integer.valueOf(FrameMetricsAggregator.EVERY_DURATION)}).contains(Integer.valueOf(responseCode));
    }
