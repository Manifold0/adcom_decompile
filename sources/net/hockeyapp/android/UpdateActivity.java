...
public class UpdateActivity extends Activity implements UpdateActivityInterface, UpdateInfoListener, OnClickListener {
    ...
    class C00241 implements DialogInterface.OnClickListener {
        C00241() {
        }
    ...
    class C00274 extends DownloadFileListener {
        C00274() {
        }
    ...
    class C00285 implements Runnable {
        C00285() {
        }
    ...
    class C00296 implements Runnable {
        C00296() {
        }
    ...
    class C00307 implements Runnable {
        C00307() {
        }
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        switch (id) {
            case 0:
                return new Builder(this).setMessage("An error has occured").setCancelable(false).setTitle("Error").setIcon(17301543).setPositiveButton("OK", new C00241()).create();
            default:
                return null;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (permissions.length != 0 && grantResults.length != 0 && requestCode == 1) {
            ...
            new Builder(this.mContext).setTitle(getString(C0982R.string.hockeyapp_permission_update_title)).setMessage(getString(C0982R.string.hockeyapp_permission_update_message)).setNegativeButton(getString(C0982R.string.hockeyapp_permission_dialog_negative_button), null).setPositiveButton(getString(C0982R.string.hockeyapp_permission_dialog_positive_button), new DialogInterface.OnClickListener() {
    ...
    public View getLayoutView() {
        return getLayoutInflater().inflate(C0982R.layout.hockeyapp_activity_update, null);
    }
    ...
    protected void configureView() {
        ((TextView) findViewById(C0982R.id.label_title)).setText(getAppName());
        final TextView versionLabel = (TextView) findViewById(C0982R.id.label_version);
            ...
            AsyncTaskUtils.execute(new GetFileSizeTask(this, getIntent().getStringExtra("url"), new DownloadFileListener() {
                public void downloadSuccessful(DownloadFileTask task) {
                    if (task instanceof GetFileSizeTask) {
                        ...
                        versionLabel.setText(UpdateActivity.this.getString(C0982R.string.hockeyapp_update_version_details_label, new Object[]{str, fileDate, appSizeString}));
                    }
                }
            }));
        }
        versionLabel.setText(getString(C0982R.string.hockeyapp_update_version_details_label, new Object[]{versionString, fileDate, appSizeString}));
        ((Button) findViewById(C0982R.id.button_update)).setOnClickListener(this);
        WebView webView = (WebView) findViewById(C0982R.id.web_update_details);
    ...
    protected void startDownloadTask(String url) {
        createDownloadTask(url, new C00274());
    ...
    public void enableUpdateButton() {
        findViewById(C0982R.id.button_update).setEnabled(true);
    }
    ...
    protected void prepareDownload() {
        if (!Util.isConnectedToNetwork(this.mContext)) {
            ...
            this.mError.setMessage(getString(C0982R.string.hockeyapp_error_no_network_message));
            runOnUiThread(new C00285());
