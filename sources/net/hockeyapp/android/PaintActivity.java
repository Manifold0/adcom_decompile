...
public class PaintActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, getString(C0982R.string.hockeyapp_paint_indicator_toast), 1).show();
    }

    public boolean onCreateOptionsMenu(Menu menu) {
        super.onCreateOptionsMenu(menu);
        menu.add(0, 1, 0, getString(C0982R.string.hockeyapp_paint_menu_save));
        menu.add(0, 2, 0, getString(C0982R.string.hockeyapp_paint_menu_undo));
        menu.add(0, 3, 0, getString(C0982R.string.hockeyapp_paint_menu_clear));
        return true;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        OnClickListener dialogClickListener = new C00221();
        new Builder(this).setMessage(C0982R.string.hockeyapp_paint_dialog_message).setPositiveButton(C0982R.string.hockeyapp_paint_dialog_positive_button, dialogClickListener).setNegativeButton(C0982R.string.hockeyapp_paint_dialog_negative_button, dialogClickListener).setNeutralButton(C0982R.string.hockeyapp_paint_dialog_neutral_button, dialogClickListener).show();
        return true;
    }
    ...
    private String determineFilename(Uri uri, String fallback) {
        String path = null;
        Cursor metaCursor = getApplicationContext().getContentResolver().query(uri, new String[]{C0603c.f895l}, null, null, null);
        if (metaCursor != null) {
            try {
