...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0982R.layout.hockeyapp_activity_login);
    ...
    private void configureView() {
        if (this.mMode == 1) {
            ((EditText) findViewById(C0982R.id.input_password)).setVisibility(4);
        }
        ((TextView) findViewById(C0982R.id.text_headline)).setText(this.mMode == 1 ? C0982R.string.hockeyapp_login_headline_text_email_only : C0982R.string.hockeyapp_login_headline_text);
        this.mButtonLogin = (Button) findViewById(C0982R.id.button_login);
        this.mButtonLogin.setOnClickListener(new C00211());
    }
    ...
    private void performAuthentication() {
        if (Util.isConnectedToNetwork(this)) {
            String email = ((EditText) findViewById(C0982R.id.input_email)).getText().toString();
            String password = ((EditText) findViewById(C0982R.id.input_password)).getText().toString();
            boolean ready = false;
            ...
            Toast.makeText(this, getString(C0982R.string.hockeyapp_login_missing_credentials_toast), 1).show();
            return;
        }
