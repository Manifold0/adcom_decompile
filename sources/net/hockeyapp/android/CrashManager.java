...
public class CrashManager {
    ...
    static class C00061 implements FilenameFilter {
        C00061() {
        }
    ...
    static class C00116 implements FilenameFilter {
        C00116() {
        }
    ...
    public static CrashDetails getLastCrashDetails() {
        ...
        for (File file : new File(Constants.FILES_PATH + "/").listFiles(new C00061())) {
    ...
    private static void showDialog(final WeakReference<Context> weakContext, final CrashManagerListener listener, final boolean ignoreDefaultHandler) {
        ...
        if (context != null) {
            if (listener == null || !listener.onHandleAlertView()) {
                ...
                builder.setMessage(C0982R.string.hockeyapp_crash_dialog_message);
                builder.setNegativeButton(C0982R.string.hockeyapp_crash_dialog_negative_button, new OnClickListener() {
                ...
                builder.setNeutralButton(C0982R.string.hockeyapp_crash_dialog_neutral_button, new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setPositiveButton(C0982R.string.hockeyapp_crash_dialog_positive_button, new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private static String getAlertTitle(Context context) {
        ...
        return String.format(context.getString(C0982R.string.hockeyapp_crash_dialog_title), new Object[]{appTitle});
    }
