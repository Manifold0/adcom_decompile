...
public class Constants {
    ...
    private static void loadCrashIdentifier(Context context) {
        String deviceIdentifier = Secure.getString(context.getContentResolver(), TapjoyConstants.TJC_ANDROID_ID);
        if (!TextUtils.isEmpty(APP_PACKAGE) && !TextUtils.isEmpty(deviceIdentifier)) {
            ...
            try {
                MessageDigest digest = MessageDigest.getInstance(com.adjust.sdk.Constants.SHA1);
    ...
    private static String tryHashStringSha256(Context context, String input) {
        ...
        try {
            MessageDigest hash = MessageDigest.getInstance(com.adjust.sdk.Constants.SHA256);
            hash.reset();
