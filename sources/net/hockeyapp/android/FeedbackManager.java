...
public class FeedbackManager {
    ...
    static class C00203 extends BroadcastReceiver {
        C00203() {
        }
    ...
    private static void startNotification() {
        ...
        int iconId = currentActivity.getResources().getIdentifier("ic_menu_camera", "drawable", TapjoyConstants.TJC_DEVICE_PLATFORM_TYPE);
        Intent intent = new Intent();
