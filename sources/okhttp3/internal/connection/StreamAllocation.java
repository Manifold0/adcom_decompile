...
public final class StreamAllocation {
    ...
    L_0x0016:
        ...
        throw r4;	 Catch:{ all -> 0x000f }
    L_0x001e:
        r4 = r8.canceled;	 Catch:{ all -> 0x000f }
    ...
    L_0x0050:
        r5 = r8.connectionPool;
        monitor-enter(r5);
        r8.route = r2;	 Catch:{ all -> 0x006e }
        r4 = 0;
        r8.refusedStreamCount = r4;	 Catch:{ all -> 0x006e }
        r1 = new okhttp3.internal.connection.RealConnection;	 Catch:{ all -> 0x006e }
        r4 = r8.connectionPool;	 Catch:{ all -> 0x006e }
        r1.<init>(r4, r2);	 Catch:{ all -> 0x006e }
        r8.acquire(r1);	 Catch:{ all -> 0x006e }
        r4 = r8.canceled;	 Catch:{ all -> 0x006e }
        if (r4 == 0) goto L_0x0071;
    L_0x0066:
        r4 = new java.io.IOException;	 Catch:{ all -> 0x006e }
        r6 = "Canceled";
        r4.<init>(r6);	 Catch:{ all -> 0x006e }
    ...
    L_0x0071:
        ...
        r5 = r8.connectionPool;
        monitor-enter(r5);
        r4 = okhttp3.internal.Internal.instance;	 Catch:{ all -> 0x00a3 }
        r6 = r8.connectionPool;	 Catch:{ all -> 0x00a3 }
        r4.put(r6, r1);	 Catch:{ all -> 0x00a3 }
        r4 = r1.isMultiplexed();	 Catch:{ all -> 0x00a3 }
        if (r4 == 0) goto L_0x009d;
    L_0x0091:
        r4 = okhttp3.internal.Internal.instance;	 Catch:{ all -> 0x00a3 }
        r6 = r8.connectionPool;	 Catch:{ all -> 0x00a3 }
        r7 = r8.address;	 Catch:{ all -> 0x00a3 }
        r3 = r4.deduplicate(r6, r7, r8);	 Catch:{ all -> 0x00a3 }
        r1 = r8.connection;	 Catch:{ all -> 0x00a3 }
    L_0x009d:
