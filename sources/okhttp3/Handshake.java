...
public final class Handshake {
    ...
    public int hashCode() {
        return (((((((this.tlsVersion != null ? this.tlsVersion.hashCode() : 0) + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + this.cipherSuite.hashCode()) * 31) + this.peerCertificates.hashCode()) * 31) + this.localCertificates.hashCode();
    }
}
