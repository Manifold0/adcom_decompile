...
public final class ConnectionSpec {
    ...
    public int hashCode() {
        ...
        return ((((Arrays.hashCode(this.cipherSuites) + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + Arrays.hashCode(this.tlsVersions)) * 31) + (this.supportsTlsExtensions ? 0 : 1);
    }
