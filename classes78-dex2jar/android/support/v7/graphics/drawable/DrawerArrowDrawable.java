...
public class DrawerArrowDrawable extends Drawable
{
    ...
    public void draw(final Canvas canvas) {
        ...
        switch (this.mDirection) {
            default: {
                b = (DrawableCompat.getLayoutDirection((Drawable)this) == 1);
                break;
            }
            case 0: {
                b = false;
            ...
            case 3: {
                b = (DrawableCompat.getLayoutDirection((Drawable)this) == 0);
                break;
            }
        }
        ...
        canvas.translate((float)bounds.centerX(), (int)(bounds.height() - 3.0f * strokeWidth - this.mBarGap * 2.0f) / 4 * 2 + (1.5f * strokeWidth + this.mBarGap));
        if (this.mSpin) {
            int n7;
