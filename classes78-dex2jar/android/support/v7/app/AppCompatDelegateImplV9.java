    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            ...
            if (Build$VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener((View)contentView, (OnApplyWindowInsetsListener)new OnApplyWindowInsetsListener() {
                            ...
                            this.mShowActionModePopup = new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                                        ...
                                        (AppCompatDelegateImplV9.this.mFadeAnim = ViewCompat.animate((View)AppCompatDelegateImplV9.this.mActionModeView).alpha(1.0f)).setListener((ViewPropertyAnimatorListener)new ViewPropertyAnimatorListenerAdapter() {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback
    {
        ...
        public void onDestroyActionMode(final ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                AppCompatDelegateImplV9.this.endOnGoingFadeAnimation();
                (AppCompatDelegateImplV9.this.mFadeAnim = ViewCompat.animate((View)AppCompatDelegateImplV9.this.mActionModeView).alpha(0.0f)).setListener((ViewPropertyAnimatorListener)new ViewPropertyAnimatorListenerAdapter() {
                    public void onAnimationEnd(final View view) {
