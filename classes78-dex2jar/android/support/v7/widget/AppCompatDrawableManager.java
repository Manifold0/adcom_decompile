...
public final class AppCompatDrawableManager
{
    ...
    private void addDelegate(@NonNull final String s, @NonNull final InflateDelegate inflateDelegate) {
        if (this.mDelegates == null) {
            this.mDelegates = (ArrayMap<String, InflateDelegate>)new ArrayMap();
        }
        this.mDelegates.put((Object)s, (Object)inflateDelegate);
    }
        ...
        if (constantState != null) {
            synchronized (this.mDrawableCacheLock) {
                ...
                if ((longSparseArray = this.mDrawableCaches.get(context)) == null) {
                    ...
                    this.mDrawableCaches.put(context, (LongSparseArray<WeakReference<Drawable$ConstantState>>)longSparseArray);
                }
                longSparseArray.put(n, (Object)new WeakReference(constantState));
                return true;
            }
        }
        return false;
    ...
    private void addTintListToCache(@NonNull final Context context, @DrawableRes final int n, @NonNull final ColorStateList list) {
        ...
        if ((sparseArrayCompat = this.mTintLists.get(context)) == null) {
            ...
            this.mTintLists.put(context, (SparseArrayCompat<ColorStateList>)sparseArrayCompat);
        }
        sparseArrayCompat.append(n, (Object)list);
    }
    ...
    private Drawable loadDrawableFromDelegates(@NonNull final Context context, @DrawableRes final int n) {
        ...
        Label_0081: {
            if (this.mKnownDrawableIdTags == null) {
                this.mKnownDrawableIdTags = (SparseArrayCompat<String>)new SparseArrayCompat();
                break Label_0081;
            }
            final String s = (String)this.mKnownDrawableIdTags.get(n);
            if (!"appcompat_skip_skip".equals(s) && (s == null || this.mDelegates.get((Object)s) != null)) {
                break Label_0081;
            }
            return null;
        }
        ...
        Label_0256: {
            if (mTypedValue.string != null) {
                ...
                if (mTypedValue.string.toString().endsWith(".xml")) {
                    ...
                    final InflateDelegate inflateDelegate = (InflateDelegate)this.mDelegates.get((Object)name);
    ...
    private void removeDelegate(@NonNull final String s, @NonNull final InflateDelegate inflateDelegate) {
        if (this.mDelegates != null && this.mDelegates.get((Object)s) == inflateDelegate) {
            this.mDelegates.remove((Object)s);
        }
    }
    ...
    private static class AvdcInflateDelegate implements InflateDelegate
    {
        ...
        public Drawable createFromXmlInner(@NonNull final Context context, @NonNull final XmlPullParser xmlPullParser, @NonNull final AttributeSet set, @Nullable final Resources$Theme resources$Theme) {
            try {
                return (Drawable)AnimatedVectorDrawableCompat.createFromXmlInner(context, context.getResources(), xmlPullParser, set, resources$Theme);
            }
            catch (Exception ex) {
    ...
    private static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter>
    {
        ...
        PorterDuffColorFilter get(final int n, final PorterDuff$Mode porterDuff$Mode) {
            return (PorterDuffColorFilter)this.get((Object)generateCacheKey(n, porterDuff$Mode));
        }
        ...
        PorterDuffColorFilter put(final int n, final PorterDuff$Mode porterDuff$Mode, final PorterDuffColorFilter porterDuffColorFilter) {
            return (PorterDuffColorFilter)this.put((Object)generateCacheKey(n, porterDuff$Mode), (Object)porterDuffColorFilter);
        }
    }
    ...
    private static class VdcInflateDelegate implements InflateDelegate
    {
        ...
        public Drawable createFromXmlInner(@NonNull final Context context, @NonNull final XmlPullParser xmlPullParser, @NonNull final AttributeSet set, @Nullable final Resources$Theme resources$Theme) {
            try {
                return (Drawable)VectorDrawableCompat.createFromXmlInner(context.getResources(), xmlPullParser, set, resources$Theme);
            }
            catch (Exception ex) {
