...
abstract class AbsActionBarView extends ViewGroup
{
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int n, final long n2) {
        ...
        if (n == 0) {
            ...
            alpha.setListener((ViewPropertyAnimatorListener)this.mVisAnimListener.withFinalVisibility(alpha, n));
            return alpha;
        }
        final ViewPropertyAnimatorCompat alpha2 = ViewCompat.animate((View)this).alpha(0.0f);
        alpha2.setDuration(n2);
        alpha2.setListener((ViewPropertyAnimatorListener)this.mVisAnimListener.withFinalVisibility(alpha2, n));
        return alpha2;
    }
