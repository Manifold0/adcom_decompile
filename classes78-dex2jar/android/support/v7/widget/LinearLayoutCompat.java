...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    void measureHorizontal(final int n, final int n2) {
        ...
        int n17 = (resolveSizeAndState & 0xFFFFFF) - this.mTotalLength;
        int n39 = 0;
        int n40 = 0;
        int n41 = 0;
        int max8 = 0;
        Label_2121: {
            if (n6 != 0 || (n17 != 0 && mWeightSum > 0.0f)) {
                ...
                while (k < virtualChildCount) {
                    ...
                    if (virtualChild3 != null) {
                        if (virtualChild3.getVisibility() == 8) {
                            ...
                            int n26 = n3;
                            int n27 = n17;
                            float n28 = mWeightSum;
                            if (weight > 0.0f) {
                                int n29 = (int)(n17 * weight / mWeightSum);
                                n28 = mWeightSum - weight;
                                final int n30 = n17 - n29;
                                ...
                                if (layoutParams3.width != 0 || mode != 1073741824) {
                                    int n31;
                                    if ((n31 = virtualChild3.getMeasuredWidth() + n29) < 0) {
                                        n31 = 0;
                                    }
                                    virtualChild3.measure(View$MeasureSpec.makeMeasureSpec(n31, 1073741824), childMeasureSpec);
                                }
                                else {
                                    if (n29 <= 0) {
                                        n29 = 0;
                            ...
                            final int n33 = layoutParams3.topMargin + layoutParams3.bottomMargin;
                            final int n34 = virtualChild3.getMeasuredHeight() + n33;
                            final int max6 = Math.max(n18, n34);
                            int n35;
                            if (n32 != 0) {
                                n35 = n33;
                            }
                            ...
                            final int max7 = Math.max(n19, n35);
                            int n36;
                            ...
                            if (mBaselineAligned) {
                                ...
                                if (baseline2 != -1) {
                                    ...
                                    if (layoutParams3.gravity < 0) {
                                        ...
                                        n37 = layoutParams3.gravity;
                                    }
                                    final int n38 = ((n37 & 0x70) >> 4 & 0xFFFFFFFE) >> 1;
                                    mMaxAscent[n38] = Math.max(mMaxAscent[n38], baseline2);
                                    mMaxDescent[n38] = Math.max(mMaxDescent[n38], n34 - baseline2);
                                    n20 = n36;
                                    n21 = max7;
                                    n22 = n26;
                                    n23 = n27;
                ...
                max8 = Math.max(n18, Math.max(mMaxAscent[3], Math.max(mMaxAscent[0], Math.max(mMaxAscent[1], mMaxAscent[2]))) + Math.max(mMaxDescent[3], Math.max(mMaxDescent[0], Math.max(mMaxDescent[1], mMaxDescent[2]))));
                n41 = n3;
                n40 = n19;
                n39 = n4;
            }
                ...
                if (mUseLargestChild) {
                    ...
                    if (mode != 1073741824) {
                        ...
                        while (true) {
                            ...
                            n41 = n3;
                            max8 = max5;
                            if (n42 >= virtualChildCount) {
                                break;
                            }
                            final View virtualChild4 = this.getVirtualChildAt(n42);
        ...
        this.setMeasuredDimension((0xFF000000 & n41) | resolveSizeAndState, View.resolveSizeAndState(Math.max(n43 + (this.getPaddingTop() + this.getPaddingBottom()), this.getSuggestedMinimumHeight()), n2, n41 << 16));
        if (n5 != 0) {
    ...
    void measureVertical(final int n, final int n2) {
        ...
        for (int i = 0; i < virtualChildCount; ++i, n6 = max4) {
            ...
            if (virtualChild == null) {
                ...
                final int n13 = virtualChild.getMeasuredWidth() + n12;
        ...
        final int n14 = (resolveSizeAndState & 0xFFFFFF) - this.mTotalLength;
        int max5;
        int n27;
        int n28;
        if (n5 != 0 || (n14 != 0 && mWeightSum > 0.0f)) {
            if (this.mWeightSum > 0.0f) {
                mWeightSum = this.mWeightSum;
            }
            this.mTotalLength = 0;
            ...
            while (k < virtualChildCount) {
                ...
                if (virtualChild3.getVisibility() == 8) {
                    ...
                    n17 = combineMeasuredStates;
                    n16 = n15;
                    float n19 = mWeightSum;
                    if (weight > 0.0f) {
                        int n20 = (int)(n15 * weight / mWeightSum);
                        n19 = mWeightSum - weight;
                        ...
                        if (layoutParams3.height != 0 || mode2 != 1073741824) {
                            int n22;
                            if ((n22 = virtualChild3.getMeasuredHeight() + n20) < 0) {
                                n22 = 0;
                            }
                            virtualChild3.measure(childMeasureSpec, View$MeasureSpec.makeMeasureSpec(n22, 1073741824));
                        }
                        else {
                            if (n20 <= 0) {
                                n20 = 0;
                        ...
                        n16 = n21;
                        n17 = combineMeasuredStates2;
                    }
                    final int n23 = layoutParams3.leftMargin + layoutParams3.rightMargin;
                    final int n24 = virtualChild3.getMeasuredWidth() + n23;
                    max5 = Math.max(max5, n24);
                    int n25;
                ...
                n3 = n18;
                max2 = max6;
                combineMeasuredStates = n17;
                n15 = n16;
            }
            this.mTotalLength += this.getPaddingTop() + this.getPaddingBottom();
            n27 = combineMeasuredStates;
            n28 = n3;
        }
        else {
            ...
            if (mUseLargestChild) {
                ...
                if (mode2 != 1073741824) {
                    ...
                    while (true) {
                        ...
                        n27 = combineMeasuredStates;
                        max5 = max;
                        if (n29 >= virtualChildCount) {
                            break;
                        }
                        final View virtualChild4 = this.getVirtualChildAt(n29);
                        if (virtualChild4 != null && virtualChild4.getVisibility() != 8 && ((LayoutParams)virtualChild4.getLayoutParams()).weight > 0.0f) {
        ...
        this.setMeasuredDimension(View.resolveSizeAndState(Math.max(n30 + (this.getPaddingLeft() + this.getPaddingRight()), this.getSuggestedMinimumWidth()), n, n27), resolveSizeAndState);
        if (n4 != 0) {
