...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem
{
    ...
    public MenuItem setActionProvider(final ActionProvider actionProvider) {
        ...
        supportMenuItem.setSupportActionProvider((android.support.v4.view.ActionProvider)actionProviderWrapper);
    ...
    class ActionProviderWrapper extends android.support.v4.view.ActionProvider
    {
        ...
        public ActionProviderWrapper(final Context context, final ActionProvider mInner) {
            super(context);
            this.mInner = mInner;
        }
