...
public class BoltsMeasurementEventListener extends BroadcastReceiver
{
    ...
    private void close() {
        LocalBroadcastManager.getInstance(this.applicationContext).unregisterReceiver((BroadcastReceiver)this);
    }
    ...
    private void open() {
        LocalBroadcastManager.getInstance(this.applicationContext).registerReceiver((BroadcastReceiver)this, new IntentFilter("com.parse.bolts.measurement_event"));
    }
