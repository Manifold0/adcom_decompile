...
public final class FileLruCache
{
    ...
    public InputStream get(final String p0, final String p1) throws IOException {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //     3: dup            
        //     4: aload_0        
        //     5: getfield        com/facebook/internal/FileLruCache.directory:Ljava/io/File;
        //     8: aload_1        
        //     9: invokestatic    com/facebook/internal/Utility.md5hash:(Ljava/lang/String;)Ljava/lang/String;
        ...
        //    26: astore          6
        //    28: new             Ljava/io/BufferedInputStream;
        //    31: dup            
        //    32: aload           6
        //    34: sipush          8192
        //    37: invokespecial   java/io/BufferedInputStream.<init>:(Ljava/io/InputStream;I)V
        //    40: astore          6
        //    42: aload           6
        //    44: invokestatic    com/facebook/internal/FileLruCache$StreamHeader.readHeader:(Ljava/io/InputStream;)Lorg/json/JSONObject;
        //    47: astore          8
        //    49: aload           8
        //    51: ifnonnull       70
        //    54: iconst_0       
        ...
        //    70: aload           8
        //    72: ldc             "key"
        //    74: invokevirtual   org/json/JSONObject.optString:(Ljava/lang/String;)Ljava/lang/String;
        //    77: astore          9
        //    79: aload           9
        //    81: ifnull          95
        //    84: aload           9
        ...
        //    96: ifne            104
        //    99: aload           6
        //   101: invokevirtual   java/io/BufferedInputStream.close:()V
        //   104: aconst_null    
        //   105: areturn        
        //   106: aload           8
        //   108: ldc             "tag"
        //   110: aconst_null    
        //   111: invokevirtual   org/json/JSONObject.optString:(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
        //   114: astore_1       
        //   115: aload_2        
        //   116: ifnonnull       123
        //   119: aload_1        
        ...
        //   146: aconst_null    
        //   147: areturn        
        //   148: new             Ljava/util/Date;
        //   151: dup            
        //   152: invokespecial   java/util/Date.<init>:()V
        //   155: invokevirtual   java/util/Date.getTime:()J
        //   158: lstore          4
        //   160: getstatic       com/facebook/LoggingBehavior.CACHE:Lcom/facebook/LoggingBehavior;
        //   163: getstatic       com/facebook/internal/FileLruCache.TAG:Ljava/lang/String;
        //   166: new             Ljava/lang/StringBuilder;
        //   169: dup            
        //   170: invokespecial   java/lang/StringBuilder.<init>:()V
        //   173: ldc_w           "Setting lastModified to "
        ...
        //   193: aload           7
        //   195: invokevirtual   java/io/File.getName:()Ljava/lang/String;
        ...
        //   204: invokestatic    com/facebook/internal/Logger.log:(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
        //   207: aload           7
        //   209: lload           4
        //   211: invokevirtual   java/io/File.setLastModified:(J)Z
        //   214: pop            
        //   215: aload           6
        //   217: astore_1       
        //   218: iconst_1       
        //   219: ifne            65
        //   222: aload           6
        //   224: invokevirtual   java/io/BufferedInputStream.close:()V
        //   227: aload           6
        //   229: areturn        
        //   230: astore_1       
        //   231: iconst_0       
        //   232: ifne            240
        //   235: aload           6
        //   237: invokevirtual   java/io/BufferedInputStream.close:()V
        //   240: aload_1        
        //   241: athrow         
        //    Exceptions:
        ...
        //  Start  End    Start  End    Type                 
        //  -----  -----  -----  -----  ---------------------
        //  17     28     67     70     Ljava/io/IOException;
        //  42     49     230    242    Any
        //  70     79     230    242    Any
        //  84     91     230    242    Any
        //  106    115    230    242    Any
