...
public class TapjoyConstants
{
    ...
    static {
        dependencyClassNames = new String[] { "com.tapjoy.TJAdUnitActivity", "com.tapjoy.TJContentActivity", "com.tapjoy.mraid.view.ActionHandler", "com.tapjoy.mraid.view.Browser" };
        dependencyPermissions = new String[] { "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE" };
        optionalPermissions = new String[] { "android.permission.ACCESS_WIFI_STATE" };
    }
}
