...
final class GsonRequestBodyConverter<T> implements Converter<T, RequestBody>
{
    ...
    public RequestBody convert(final T t) throws IOException {
        ...
        final JsonWriter jsonWriter = this.gson.newJsonWriter((Writer)new OutputStreamWriter(buffer.outputStream(), GsonRequestBodyConverter.UTF_8));
        this.adapter.write(jsonWriter, (Object)t);
        jsonWriter.close();
