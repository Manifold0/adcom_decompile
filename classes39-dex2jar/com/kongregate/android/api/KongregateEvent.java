...
{
    public static final String CHARACTER_TOKEN_REQUEST = "KONG_API_EVENT_CHARACTER_TOKEN_REQUEST";
    ...
    public static final String NOTIFICATION_COUNT_UPDATED = "KONG_API_EVENT_NOTIFICATION_COUNT_UPDATED";
    public static final String OPENING_KONGREGATE = "KONG_API_EVENT_OPENING_KONGREGATE";
    public static final String OPEN_DEEP_LINK = "KONG_API_EVENT_OPEN_DEEP_LINK";
    ...
    public static final String PROMO_AWARD = "KONG_API_EVENT_PROMO_AWARD";
